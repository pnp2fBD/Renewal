...
public class Log extends BaseTest {
   ...
   */
  public static void assertThatExtentReport(boolean status, String passmsg, String failmsg, WebDriver driver, ExtentTest extentedReport) {
    if (!status) {
      Log.fail(failmsg, driver,extentedReport);
      // extentReporterTest.log(LogStatus.FAIL, failmsg);
    } else {
      Log.message(passmsg, driver,extentedReport);
  ...
  public static void failAssertSet(String description, WebDriver driver, ExtentTest extentedReport,
      Boolean... takeScreenShot) {
