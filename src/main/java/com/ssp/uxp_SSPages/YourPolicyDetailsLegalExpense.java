...
public class YourPolicyDetailsLegalExpense extends LoadableComponent<YourPolicyDetailsLegalExpense>{
  ...
  @FindBy(xpath = "//h2[contains(text(),'Legal Expenses')]")
  WebElement leCoverHead;
  ...
  @FindBy(css = "input[id*='ComponentLE_amountRequired']")
  WebElement leCoverLmit;

  public YourPolicyDetailsLegalExpense(WebDriver driver, ExtentTest extentedReport) {
    this.driver = driver;
  ...
  protected void isLoaded() {
    ...
    (new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
        ...
        .withMessage("Your Policy Details page did not open up."))
            .until(ExpectedConditions.visibilityOf(leCoverHead));
   ...
   * @throws Exception
   */
  public YourQuotePageFromPP clickNextBtn(boolean screenshot) throws Exception {
   ...
   * @throws Exception
   */
  public YourPolicyDetailsHomeEmergency clickBacktBtn(boolean screenshot) throws Exception {
    ...
    try {
      ...
      Log.message("User has clicked back button and navigated.", driver, extentedReport,
          screenshot);
      return new YourPolicyDetailsHomeEmergency(driver, extentedReport).get();
    } catch (Exception e) {
