...
public class YourPolicyDetailsTechnologyCover extends LoadableComponent<YourPolicyDetailsTechnologyCover> {
  ...
  @FindBy(xpath = "//h2[contains(text(),'Technology & Entertainment Cover')]")
  WebElement teCoverHead;
  ...
  public YourPolicyDetailsTechnologyCover(WebDriver driver, ExtentTest extentedReport) {
        this.driver = driver;
  ...
  protected void isLoaded() {
    ...
    (new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
        ...
        .withMessage("Your Policy Details page did not open up."))
            .until(ExpectedConditions.visibilityOf(teCoverHead));
   ...
   * @throws Exception
   */
  public YourPolicyDetailsHomeEmergency clickNextBtn(boolean screenshot) throws Exception {
   ...
   * @throws Exception
   */
  public YourPolicyDetailsGardenCover clickBacktBtn(boolean screenshot) throws Exception {
