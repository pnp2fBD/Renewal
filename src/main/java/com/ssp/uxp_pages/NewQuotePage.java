...
public class NewQuotePage extends LoadableComponent<NewQuotePage> {
  ...
  private int tableTCSize;
  private int afterTCAttachTablesize;
  ...
  private String editedTCTilte;
  private String editedTCDescp;
  private String tcType;
  private String exitingTCEdit;

  private void setExitingTCEdit(HashMap<String,String> testdata) throws Exception {
    this.exitingTCEdit = testdata.get("Terms and Conditions_Edit");
    if(exitingTCEdit.equals("")){
      throw new Exception("Please enter field value separated with comma(',') 'Terms and Conditions_Edit' in testdata");
    }
  }
  ...
  private void setTcType(HashMap <String,String> testdata) throws Exception {
    ...
    if(tcType.equals("")){
      throw new Exception("Please enter value for TCType field in testdata sheet");
    }
  }
  
  private void setPaymentInfo(HashMap<String,String> testdata) throws Exception {
    this.accNo = testdata.get("Account Number");
    this.sortCode = testdata.get("Sort Code");
    this.paymentPlan = testdata.get("Payment Plan");
    this.paymentMethod = testdata.get("Payment Method");
    if(paymentPlan.equalsIgnoreCase("Monthly")){
      if(paymentMethod.equals("")){
        throw new Exception("Please enter : paymentMethod in testdata sheet");
      }
      if(accNo.equals("")||sortCode.equals("")){
        throw new Exception("Please enter : sortcode and accountNo in testdata sheet");
      }
    }else if(paymentPlan.equalsIgnoreCase("Annual")){
      if(paymentMethod.equals("")){
        throw new Exception("Please enter : paymentMethod in testdata sheet");
      }
    }
    else
      throw new Exception("Please enter : paymentPlan in testdata sheet");
  }

  private String tcClickXpathPrefix = "//span[contains(text(),'";
  private String tcClickXpathSuffix =  "')]";
  private String tcTitle;
  private String tcEditBtnPrefix = "button[id*='C2__C1__BUT_304899FEFEF1DDEB941705_R1_";
  private String tcEditBtnSuffix = "'][title*='Edit']";
  private String tcEditDescpPrefix = "[id*='C2__C1__QUE_A048EC24ED762AD77362602_R1_";
  private String tcEditDescpSuffix = "']";
  private String addTandCRowXpathPrefix = "//span[contains(text(),'";
  private String addTandCRowXpathSuffix = "')]/ancestor::div[contains(@class,'cls_selectrow')]";
  private String tandcSelectButtonXpath = "/following-sibling::div//button[contains(@value,'Select')]";
  private String tandcEditButtonXpath = "/following-sibling::div//button[contains(@value,'Select')]";
  ...
  public final String ele_radio_var = "#C2__FS_QUE_D6A69F84D226E30B1415462 label";
  ...
  public String radioReviewed = "#C2__QUE_D6A69F84D226E30B1415462_0";
  ...
  @FindBy(css = "#C2__BUT_728A190A046539422453470")
  WebElement saveHECover;
  
  @FindBy(css = "#C2__BUT_728A190A046539422453655")
  WebElement saveLECover;
  ...
  // #pmitem_0 > a > div.pm-thumb > img
  // input[name='op-DPChoose-VISA^SSL'][alt='Visa']
  ...
  @FindBy(css = "	#C2__BUT_C1E4BAA49905B19C1326231")
  WebElement btnInvoice_Accept;
  @FindBy(css = "#C2__BUT_D6A69F84D226E30B688855")
  WebElement btn_renewQuotevariationSave;
  @FindBy(css = "#C2__QUE_D6A69F84D226E30B1415462_0")
  WebElement radio_variationPop_up_Reviewed;
  @FindBy(css = " #C2__QUE_83B5913BCD115CC1794679")
  WebElement text_variation;
  @FindBy(css = "#C2__BUT_D6A69F84D226E30B1415464")
  WebElement but_save_variation;
  @FindBy(css = "#C2__C6__QUE_19504DF73EA7BBF571890_R2")
  WebElement renewalDate;
  @FindBy(css = "#C2__C6__QUE_19504DF73EA7BBF571896_R2")
  WebElement renewalPremium;
  @FindBy(css = "#C2__C6__QUE_19504DF73EA7BBF571896_R1")
  WebElement policyPremium;
  
  @FindBy(xpath = "//button[contains(text(),'Create Free Format')]")
  WebElement createFreeFormatBtn;
  @FindBy(css = "input[name*='NEWTERMSANDCONDITIONS[1].FREEFORMAT[1].TITLE']")
  WebElement createFreeTCTitle;
  @FindBy(css = "input[name*='NEWTERMSANDCONDITIONS[1].FREEFORMAT[1].FREETEXT']")
  WebElement createFreeTCWording;
  @FindBy(css = "div[id*='C2__C1__p4_BUT_CCE81E6B9C5C9F7B257236'] button[title*='Save']")
  WebElement createFreeTCSaveBtn;
  @FindBy(css = "div[id*='EmptyMessageFMT']")
  List<WebElement> tcTableSectionSize;
  @FindBy(css = "div[id*='C2__C1__p4_BUT_304899FEFEF1DDEB941705_R1']:not([style*='display: none']) button[title*='Edit']")
  WebElement tcEditBtn;
  @FindBy(css = "div[id*='C2__C1__p4_QUE_A048EC24ED762AD77362602_R1']:not([style*='display: none'])")
  WebElement tcEditDescriptionTextBox;
  @FindBy(css = "div[id*='C2__C1__p4_BUT_304899FEFEF1DDEB1181295_R1'][style*='display'] button[title*='Save']")
  WebElement tcEditDescriptionSaveBtn;
  @FindBy(css = "div[class*='form-group clearfix margin_zero terms_rowclick']")
  ...
  public int originalNoTC() throws Exception{
    try{
      WaitUtils.waitForListElement(driver, tcTableSectionSize, 2);
      tableTCSize = tcTableSectionSize.size();
      return tableTCSize;
    }catch(Exception e){
      throw new Exception("Unable to find original no. of TC : " + e);
    }  
  }
  
  public int newNoTC() throws Exception{
    try{
      WaitUtils.waitForListElement(driver, tcTableSectionSize, 2);
      afterTCAttachTablesize = tcTableSectionSize.size();
      return afterTCAttachTablesize;
    }catch(Exception e){
      throw new Exception("Unable to find new no. of TC : " + e);
    }  
  }

  /**
   * Verification of added TC
   * 
   * @param Screenshot
   * @param extentReport
   * @throws Exception
   */
  public void verifyAdditionOfTC( int orgValue,int newValue, boolean Screenshot, ExtentTest extentReport) throws Exception {

    try {
      if (newValue > orgValue) {
        Log.pass("TC rows have been added successfully", driver, extentReport, Screenshot);
      } else {
        Log.fail("TC rows have not been added", driver, extentReport, Screenshot);
        throw new Exception("TC row not added");
      }
    } catch (Exception e) {
      throw new Exception("Unable to verify addition of TC : " + e);
    }
  }
   ...
   * @throws Exception
   */
  public void addTermsAndCondition(String tAndC, boolean Screenshot,
      ExtentTest extentReport) throws Exception{   
    try{
        String xpathRow = addTandCRowXpathPrefix + tAndC + addTandCRowXpathSuffix;
        WebElement row = driver.findElement(By.xpath(xpathRow));
        WaitUtils.waitForElementPresent(driver, row, "The T&C- "+tAndC+" row is not displayed");
        row.click();
        String xpathSelect = addTandCRowXpathPrefix + tAndC + addTandCRowXpathSuffix + tandcSelectButtonXpath;
        WebElement selectButton = driver.findElement(By.xpath(xpathSelect));
        WaitUtils.waitForElementPresent(driver, selectButton, "The T&C- "+tAndC+" Select button is not present");
        GenericUtils.javaScriptExecutorToClick(driver, selectButton);
        WaitUtils.waitForSpinner(driver);     
    }catch (Exception e) {
      throw new Exception("Unable to add a TC : " + e);
    }
  }
   ...
   * @throws Exception
   */
  public void editTermsAndCondition(String tAndC, boolean Screenshot,
      ExtentTest extentReport) throws Exception{   
    try{
        String xpathRow = addTandCRowXpathPrefix + tAndC + addTandCRowXpathSuffix;
        WebElement row = driver.findElement(By.xpath(xpathRow));
   ...
   * @throws Exception
   */
  public void createFreeStyleTC(HashMap<String, String> testdata, boolean Screenshot,
      ExtentTest extentReport) throws Exception {
    
    String tcTitle = testdata.get("TCTitle") + counter;
    String tcWord = testdata.get("TCWord") + counter;
    counter++;
    
    try{
        WaitUtils.waitForElementPresent(driver, createFreeFormatBtn, "Create Free Format button not displayed");
        WaitUtils.waitForelementToBeClickable(driver, createFreeFormatBtn, "Unable to click Create Free Format button");
        createFreeFormatBtn.click();
        
        WaitUtils.waitForSpinner(driver);
        
        WaitUtils.waitForElementPresent(driver, createFreeTCTitle, "Title text box not present");
        createFreeTCTitle.clear();
        createFreeTCTitle.sendKeys(tcTitle);
        
        WaitUtils.waitForElementPresent(driver, createFreeTCWording, "Wordings text box not present");
        createFreeTCWording.clear();
        createFreeTCWording.sendKeys(tcWord);
        
        WaitUtils.waitForElementPresent(driver, createFreeTCSaveBtn, "Create Free Format Save button not displayed");
        WaitUtils.waitForelementToBeClickable(driver, createFreeTCSaveBtn, "Unable to click Create Free Format Save button");
        createFreeTCSaveBtn.click();
        
        WaitUtils.waitForSpinner(driver);
        
    }catch (Exception e) {
      throw new Exception("Unable to create free style TC : " + e);
    }
  }
   ...
   * @throws Exception
   */
  public void editTC(HashMap<String, String> testdata, boolean Screenshot,
      ExtentTest extentReport) throws Exception{
    try{
      setTcType(testdata);
      String tcTitle=null;
      ...
      if(tcType.equalsIgnoreCase("freeStyle")){
        tcTitle = testdata.get("TCTitle");
        tcTitle = tcTitle + (counter-1);
        editedTCTilte = tcTitle;
        editDescp = "Edit"+testdata.get("TCWord") + (counter-1);
        editedTCDescp = editDescp;
      }else if(tcType.equalsIgnoreCase("existingSystem")){
        setExitingTCEdit(testdata);
        tcTitle = exitingTCEdit;
        editedTCTilte = tcTitle;
        editDescp = "Edit TC- "+tcTitle;
        editedTCDescp = editDescp;
      } 
      String xpath = tcClickXpathPrefix + tcTitle + tcClickXpathSuffix;
      WebElement tcToEdit = driver.findElement(By.xpath(xpath));
      WaitUtils.waitForElementPresent(driver, tcToEdit, "The selected TC row is not present");
      tcToEdit.click();
      String cssEditBtn = tcEditBtnPrefix+tcTableSectionSize.size()+tcEditBtnSuffix;
      WebElement tcEditButton = driver.findElement(By.cssSelector(cssEditBtn));
      WaitUtils.waitForElementPresent(driver, tcEditButton, "Edit button for TC is not present");
      tcEditButton.click();
      Thread.sleep(2000);
      String cssDescpBox = "[id*='C2__C1__QUE_A048EC24ED762AD77362602_R1_"+tcTableSectionSize.size()+"']";
      WebElement tcEditDescpTxtBox = driver.findElement(By.cssSelector(cssDescpBox));
      tcEditDescpTxtBox.click();
      tcEditDescpTxtBox.clear();
      ((JavascriptExecutor) driver).executeScript("arguments[0].innerText ='"+editDescp+"'",
          tcEditDescpTxtBox);
      WaitUtils.waitForElementPresent(driver, tcEditDescriptionSaveBtn, "TC description Save button is not present");
      tcEditDescriptionSaveBtn.click();
      WaitUtils.waitForSpinner(driver);
    }catch (Exception e) {
      throw new Exception("Unable to edit TC : " + e);
    }
  }
  
  /**
   * To verify edited description for T&C
   * 
   * @param tcType
   * @param testdata
   * @param Screenshot
   ...
   * @throws Exception
   */
  public void verifyEditedTCDetails(HashMap<String, String> testdata, boolean Screenshot,
      ExtentTest extentReport) throws Exception{
    try{
      setTcType(testdata);
      String xpath = tcClickXpathPrefix + editedTCTilte + tcClickXpathSuffix;
      WebElement tcToEdit = driver.findElement(By.xpath(xpath));
      WaitUtils.waitForElementPresent(driver, tcToEdit, "The selected TC row is not present");
      tcToEdit.click();
      Thread.sleep(2000);
      String cssDescpBox = "[id*='C2__C1__QUE_A048EC24ED762AD77362602_R1_"+tcTableSectionSize.size()+"']";
      WebElement tcEditDescpTxtBox = driver.findElement(By.cssSelector(cssDescpBox));
      String description = tcEditDescpTxtBox.getText();     
      if(description.equals(editedTCDescp)){
        Log.pass("The edited description is present", driver, extentReport, Screenshot);
      }
      else
        Log.fail("The edited description is not present", driver, extentReport, Screenshot);
    }catch (Exception e) {
      throw new Exception("Unable to vaidate edited TC : " + e);
    }
  }
  ...
  public void clickAttachTermAndConditionButton(ExtentTest extentedReport) throws Exception {
    try {
      ...
      WaitUtils.waitForelementToBeClickable(driver, btnAttachTermAndCondition, "Attach T&C button is not clickable");
      btnAttachTermAndCondition.click();
      WaitUtils.waitForSpinner(driver);
      Log.message("Clicked on button - Attach Term and Condition", driver, extentedReport, true);
    } catch (Exception e) {
   ...
   * @throws Exception
   */
  public String returnAccountName() throws Exception{
    try{
      ...
      throw new Exception("Exception occured, account name return method " + e);
    }   
  }
  ...
  public void clickBuyMTA(ExtentTest extentedReport, boolean screenshot) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, btnBuyMTA, "Buy button for MTA is not present");
      WaitUtils.waitForelementToBeClickable(driver, btnBuyMTA, "Buy button for MTA is not clickable");
      GenericUtils.javaScriptExecutorToClick(driver, btnBuyMTA);
      //btnBuyMTA.click();
      WaitUtils.waitForSpinner(driver);
  ...
  public CustDashboardPage confirmPayment(HashMap<String, String> testdata,
    ...
    try {
      ...
      switch (paymentplan) {
        case "Annual":
          WaitUtils.waitForElementPresent(driver, btnConfirmPayment, "CONFIRM button is not present");
          WaitUtils.waitForelementToBeClickable(driver, btnConfirmPayment, "CONFIRM button is not clickable");
   ...
   * @param testDataToCheck : string
   * @param Screenshot :boolean
   * @param coverCheck :boolean
   */
  public String getDefaultVals_InsCovers(String testDataToCheck, boolean screenshot,
      ExtentTest extentedReport, boolean coverCheck) throws Exception {

    String[] coversToAdd = testDataToCheck.split("_");
    
    if(coversToAdd.length<3){
      Log.failAssertSet("Incorrect test data format", driver, extentedReport, true);   
    }
    ...
    try {
      ...
      if (AddRem.equalsIgnoreCase("Add")) {
        ...
        if (strPopName.equalsIgnoreCase("Unspecified Bicycles")) {
          ...
          /*
           * ins_PCcover_coverAmt.click(); WaitUtils.waitForElementPresent(driver,
           * ins_PC_cover_RadioBut, "Unable to find the specified Pedalcyle radio button");
           * selectRadioButton(rad_ins_PC, "Yes"); Thread.sleep(2000);
           * WaitUtils.waitForElementPresent(driver, ins_PCcover_Specified_cyclecount,
           * "Unable to find the specified Item nodes on Pedalcycle window"); if
           * (ins_PCcover_Specified_cyclecount.isDisplayed()) { Select pcSpecItem = new
           * Select(ins_PCcover_Specified_cyclecount);
           ...
           * 
           * WaitUtils.waitForElementPresent(driver, ins_PCcover_SaveBut,
           * "Unable to find the save button on Pedalcycle window"); ins_PCcover_SaveBut.click(); }
           * 
           * WaitUtils.waitForinvisiblityofElement(driver, 300, PopupWnd_ins_PC, coverType +
           * " window failed to close after waiting for 3 mins");
           * WaitUtils.waitForinvisiblityofElement(driver, 300, spinner,
           * "Unable to Switch to Windows after adding Pedal cycle contents"); String Limit_Val =
           * driver.findElement(By.cssSelector(eletoInteract)).getText();
           * System.out.println("Value is " + Limit_Val); int valuetochk =
           * Integer.parseInt(testData.get("PC_UnspecifiedItems_coverAmt").toString()) +
           * Integer.parseInt(testData.get("PC_specifiedItems_coverAmt").toString()); if
           * (Limit_Val.contains(Integer.toString(valuetochk))) { BoolVal = true; //
           * Log.message("Both unspecified and specified cover // values added sucessfully, // added
           * cover amount displayed as :"+valuetochk, // extentedReport); }
           */
        }
    ...
    try {
      ...
      driver
          .findElement(By.cssSelector(
              "#C2__p1_TBL_728A190A046539421184072 > div > table > tbody > tr.Add-Ons-1 > td:nth-child(6)"))
          .click();
      ...
      if (AddRem.equalsIgnoreCase("Add")) {
        ...
        btnDashboard.click();*/
        WaitUtils.waitForElementPresent(driver, saveHECover, "HE cover save button is not present");
        WaitUtils.waitForelementToBeClickable(driver, saveHECover, "HE cover save button is not clickable");
        saveHECover.click();
        BoolVal = true;

        /*
         * WaitUtils.waitForElementPresent(driver,
         * driver.findElement(By.cssSelector(eletoInteract)),
         * "Unable to find Home Emergency cover on GetQuote page");
         * 
         * String Limit_Val = driver.findElement(By.cssSelector(eletoInteract)).getText();
         * System.out.println("Value is " + Limit_Val); if
         * (Limit_Val.contains(testData.get("AddOn_HE").toString())) { BoolVal = true; }
         * 
         */
      }
  ...
  public boolean enter_LEcoverDetails(HashMap<String, String> testData, String coverType,
    ...
    try {
      ...
      driver
      .findElement(By.cssSelector(
          "#C2__p1_TBL_728A190A046539421184072 > div > table > tbody > tr.Add-Ons-2 > td:nth-child(6)"))
      .click();
    /*  WaitUtils.waitForinvisiblityofElement(driver, 300, spinner,
      ...
      if (AddRem.equalsIgnoreCase("Add")) {
        ...
        WaitUtils.waitForElementPresent(driver, saveLECover, "LE cover save button is not present");
        WaitUtils.waitForelementToBeClickable(driver, saveLECover, "LE cover save button is not clickable");
        saveLECover.click();
        BoolVal = true;
  ...
  public void generateRenewVariation(String txtToenter) throws Exception {
    System.out.println("start");

    WaitUtils.waitForElementPresent(driver, btn_renewQuotevariationSave,
        "Save button not found,failed to save renewal quote");
    btn_renewQuotevariationSave.click();
    Log.message("Clicked on save button - Policy Renewal transaction", extentedReport);
    Thread.sleep(2000);
    WaitUtils.waitForSpinner(driver);

    List<WebElement> alradio = driver.findElements(By.cssSelector(ele_radio_var));

    for (int i = 0; i <= alradio.size(); i++)

    {

      if (!alradio.get(i).equals("Reviewed")) {

        WebElement element =
            driver.findElement(By.cssSelector("#C2__FS_QUE_D6A69F84D226E30B1415462 input"));


        Actions actions1 = new Actions(driver);
        actions1.moveToElement(alradio.get(i)).click();
        ...
        Log.message("Unable to click", extentedReport);
      }
      break;
    }
    ...
    actions1.moveToElement(text_variation).click();
    actions1.sendKeys(txtToenter);
    Thread.sleep(2000);
    actions1.sendKeys(Keys.RETURN).build().perform();
    ...
    WaitUtils.waitForElementPresent(driver, but_save_variation,
        "Failed to locate quote variation save button on quote description modal");

    actions1.moveToElement(but_save_variation).click();
   ...
   * @throws Exception : Custom Exception Message
   */
  public void click_Invoice_Acceptbtn(ExtentTest extentReport) throws Exception {
    try {
      ...
      (new WebDriverWait(driver, 4000).pollingEvery(200, TimeUnit.MILLISECONDS)
          .ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
          .withMessage("Unable to find view button"))
              .until(ExpectedConditions.elementToBeClickable(btnInvoice_Accept));
      JavascriptExecutor executor = (JavascriptExecutor) driver;
      executor.executeScript("arguments[0].click();", btnInvoice_Accept);
      // btnView.click();
      WaitUtils.waitForPageLoad(driver);
      WaitUtils.waitForSpinner(driver);
      Log.message("Clicked on Accept  Button", driver, extentReport);

    } catch (Exception e) {
      throw new Exception("Unable to Click on Accept Button :" + e);
    }
  }
  
  public String RenewalStartDate(WebDriver driver,ExtentTest extentReport)throws Exception
  {
    try {
      String renewalData=renewalDate.getText();
      return renewalData;
    } catch (Exception e) {
      throw new Exception("Unable to find renewal Start Date :" + e);
    }
  }

  public String RenewalPremium(WebDriver driver,ExtentTest extentReport)throws Exception
  {
    try {
      String renewalData=renewalPremium.getText();
      return renewalData;
    } catch (Exception e) {
      throw new Exception("Unable to find renewal premium field :" + e);
    }
  }
  
  public String policyPremium(WebDriver driver,ExtentTest extentReport)throws Exception
  {
    try {
      String renewalData=policyPremium.getText();
      return renewalData;
    } catch (Exception e) {
      throw new Exception("Unable to find NB premium field :" + e);
    }
  }
