...
public class NewQuoteMedicalConditionsPage extends LoadableComponent<NewQuoteMedicalConditionsPage>{
  ...
  @FindBy(xpath  = "//h1[text()='Medical Conditions']")
  private WebElement medicalConditionsHeading;
  
  @FindBy(css = "button[title='Continue']")
  private WebElement continueBtn;
  
  @FindBy(css = "button[title='Back'][id='C2__Back-ComponentPRD_ComponentPHD_ComponentDRV_ComponentMCD']")
  ...
  protected void isLoaded() throws Error {
    ...
    if (isPageLoaded && !medicalConditionsHeading.isDisplayed()) {
      Log.fail("User is unable to navigate to New Quote Medical Conditions page", driver, extentedReport);
  ...
  public NewQuoteMedicalConditionsPage(WebDriver driver, ExtentTest extentedReport){
    this.driver = driver;
   ...
   * @throws Exception
   */
  public NewQuotePreviousConvictionsPage clickOnContinue(WebDriver driver, ExtentTest extentedReport, boolean screenshot) throws Exception{
    try{
   ...
   * @throws Exception
   */
  public NewQuoteDriverDetailsPage clickOnBack(WebDriver driver, ExtentTest extentedReport, boolean screenshot) throws Exception{
    try{
