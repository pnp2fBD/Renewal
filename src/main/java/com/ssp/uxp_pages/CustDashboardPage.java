...
public class CustDashboardPage extends LoadableComponent<CustDashboardPage> {
  ...
  public String renewalquoteele="//*[@id='C2__C6__navdrop']/div/div/ul/li[4]/ul/li/a";
  ...
  public String cssTableVals = "#C2__C4__TBL_3B87415692E0F10617428 tbody tr:nth-child(1) td:not([style*='display: none'])";
  ...
  private String systemAuditViewClosePrefix = "//span[contains(text(),'";
  private String systemAuditViewCloseSuffix = "')]/ancestor::div[contains(@onclick,'AUTOSELECTOR_TBL')]//button[contains(@id,'ATTACHEMENT')]";
  ...
  @FindBy(css = "#C2__C6__MenuCancelCoolingOff")
  ...
  @FindBy(css = "div[id*='C2__C3__FMT_19504DF73EA7BBF5204259_R']")
  List<WebElement> systemAuditRowCount;
  ...
  @FindBy(css="#C2__C6__HEAD_1276719E6EB892F83061163")
  WebElement canceledDate;
  @FindBy(css="#C2__C6__MenuReinstatement")
  WebElement reinstatePolicy;
  @FindBy(css="#C2__C6__ITM_32BF5DA7372009F11482910 > a")
  WebElement cancelPolicy;
  @FindBy(css = "#C2__C6__MenuStdCancellation")
  ...
  @FindBy(
      css = "#C2__C6__ITM_32BF5DA7372009F11482890 > a")
  ...
  @FindBy(css = "#C2__C6__MenuManageRenewals > a")
  WebElement drpManageRenewals;
//  #li_C2__C6__Menu_InviteRenewals
  // .inviterenewal
 @FindBy(css = "li[class='dropdown open']>ul>li>div[class*='leaf-menu page-spinner']")
  WebElement drpoptInviteRenewals;
/*
  @FindBy(css = " #li_C2__C6__Menu_InviteRenewals']")
  WebElement drpoptInviteRenewals;
  */
  ...
  @FindBy(css = "button[id*='C2__C3__ATTACHEMENT_R']")
  List<WebElement> btnViewList;

  @FindBy(css = "#C2__C3__discussion_R1")
  WebElement txtpaneSystemAudit;
  
  @FindBy(css = "div[id*='p0_discussion_R']")
  List<WebElement> txtpaneSystemAuditList;
  
  @FindBy(css = "div[id*='p0_discussion_R'] div[id*='row_auditdesc_R'] div[class*='col-sm-12 noPadLft']")
  List<WebElement> txtpaneSystemAuditListMessage;

  @FindBy(css = ".dropdown-toggle.view-variations.page-spinner")
  WebElement drpRenewQotVariations;
  
  @FindBy(css = "#a_RenewalQuoteVariation")
  WebElement btnRenewQotVariations;
  
  @FindBy(css = "#C2__C1__FS_Suspend-Checking > div > label")
  WebElement suspendGDPRCheckbox;
  
  @FindBy(xpath = "//div[contains(text(),'Please note:')]")
  WebElement gdprText;
  ...
  @FindBy(css = "#C2__C1__BUT_58CF1F8E16D428CA38036")
  WebElement link_con_details;
  
  @FindBy(css = "#C2__C6__navdrop > div > div > ul > li.dropdown.renewal-quote.drop-inline.dropdown-hover.open > ul > li > a")
  WebElement   eleToClick1;

  @FindBy(css = "#C2__C6__navdrop > div > div > ul > li.dropdown.renewal-quote.drop-inline.dropdown-hover.open > ul > li:nth-child(1) > a")
  WebElement drpoptRenewalvarone;
  ...
  @FindBy(css = "span[id='C2__C6__QUE_19504DF73EA7BBF571890_R2']")
  WebElement renewalInceptionDate;
  
  @FindBy(css = "span[id='C2__C6__QUE_19504DF73EA7BBF571893_R2']")
  WebElement renewalExpiryDate;
   ...
   * 
   */
  public void enterNewQuotePastDate(int noOfDays, HashMap<String,String> testdata, ExtentTest extentReport,
      boolean Screenshot) throws Exception {
    try {
      int noOfYear = Integer.parseInt(testdata.get("RenewalBackdateYear")); 
      WaitUtils.waitForElementPresent(driver, popup_NewQuote, "New quote pop up has not shown");
      String pastAndFutureDate = null;
      SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
      Date date = new Date();
   ...
   * @throws Exception
   */
  public void enterDate(String dateType, int noOfDays, int noOfYear, ExtentTest extentReport,
      boolean Screenshot) throws Exception {
    String date = null;
    try {
      date = GenericUtils.setDate(dateType, datePicker, noOfDays, noOfYear);
      Log.message("Entered New Quote Start Date : " + date, driver, extentReport,
          Screenshot);
    } catch (Exception e) {
      throw new Exception("Unable to Enter Quote Details : " + e);
    }
  ...
  public String enterNewQuotePastDate(int noOfDays, int noOfYear, ExtentTest extentReport,
      boolean Screenshot, boolean returnType) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, popup_NewQuote, "New quote pop up has not shown");
      String pastAndFutureDate = null;
      SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
  ...
  /**
   * To click continue button for Motor policy
   * 
   * @param Screenshot
   * @param extentReport
   * @return NewQuotePage
   ...
   * 
   */
  public NewQuoteProposerDetailsPage clickContinueQuoteMotor(boolean Screenshot, ExtentTest extentReport)
      throws Exception {
    try {
      createnewQuote.click();
      Thread.sleep(3000);
    ...
    return new NewQuoteProposerDetailsPage(driver, extentReport).get();
  }
  ...
  public void clickCancelPolicy(HashMap<String, String> testdata, boolean screenshot,
    ...
    (new WebDriverWait(driver, 20).pollingEvery(200, TimeUnit.MILLISECONDS)
        ...
        .withMessage("Cancel Drop down is not clickable"))
            .until(ExpectedConditions.elementToBeClickable(cancelPolicy));
    try {
              cancelPolicy.click();
    ...
    try {
      (new WebDriverWait(driver, 20).pollingEvery(200, TimeUnit.MILLISECONDS)
          ...
          .withMessage("Reinstate Policy is not clickable"))
              .until(ExpectedConditions.elementToBeClickable(reinstatePolicy));
      reinstatePolicy.click();
      WaitUtils.waitForSpinner(driver);
  ...
  public HashMap<String, String> getPolicyURN(ExtentTest extentedReport) throws Exception {
    try {
      ...
      hmpolDetails.put("PolicyPremium",
          GenericUtils.getTextOfWebElement(policyPremium, driver));
  ...
  public HomePage clickComplete(ExtentTest extentedReport) throws Exception {
    try {
  ...
  public HashMap<String, String> getPolicyURNRenewal(ExtentTest extentedReport) throws Exception {
    try {
      HashMap<String, String> hmpolDetails = new HashMap<String, String>();
      WaitUtils.waitForelementToBeClickable(driver, getPolicyTab,
          "View More Quotes and Policies tab is not clickable");
      ...
      hmpolDetails.put("Status",
          GenericUtils.getTextOfWebElement(tbl_Policydetails.get(1), driver));
      hmpolDetails.put("InceptionDate",
          GenericUtils.getTextOfWebElement(renewalInceptionDate, driver));
      hmpolDetails.put("ExpiryDate",
          GenericUtils.getTextOfWebElement(renewalExpiryDate, driver));
      hmpolDetails.put("Product",
          GenericUtils.getTextOfWebElement(tbl_Policydetails.get(5), driver));
      hmpolDetails.put("Scheme",
          GenericUtils.getTextOfWebElement(tbl_Policydetails.get(6), driver));
      ...
      hmpolDetails.put("RenewalPremium",
          GenericUtils.getTextOfWebElement(renewalPremium, driver));
      hmpolDetails.put("PolicyPremium",
          GenericUtils.getTextOfWebElement(policyPremium, driver));
      Log.event("Policy URN : " + hmpolDetails.get("PolicyNo"));
      Log.message("Policy Created Successfully. Policy URN : " + hmpolDetails.get("PolicyNo")
  ...
  /**
   * Description : To verify System Audit History with specific user id
   * 
   * Return : boolean
   * 
   * @param extentedReport
   ...
   * @throws Exception
   */
  public boolean verifySystemAuditHistory(ExtentTest extentedReport, String[] message, String userName)
      throws Exception {
    try {
      boolean allMatched = false;
      int totalElement = message.length;
      int totalMatched = 0;
      String systemAuditDetail;
      ...
      WaitUtils.waitForSpinner(driver);
      String viewCloseBtnXpath = systemAuditViewClosePrefix+userName+systemAuditViewCloseSuffix;
      WebElement viewCloseBtn = driver.findElement(By.xpath(viewCloseBtnXpath));
      WaitUtils.waitForElementPresent(driver, viewCloseBtn, "View/Close button for system audit of user- "+userName+" is not displayed");
      //btnView1.click();
      viewCloseBtn.click();
      GenericUtils.scrollIntoView(driver, txtpaneSystemAuditList);
      Thread.sleep(2000);
      for(WebElement audit : txtpaneSystemAuditListMessage){
        systemAuditDetail = audit.getText().toString().trim();
        for (int i = 0; i < totalElement; i++) {
          if (systemAuditDetail.contains(message[i].trim())) {
            totalMatched++;
            Log.message(
                message[i].trim() + " - is present in the system audit detail - " + systemAuditDetail,
                driver, extentedReport);
            break;
          }
        }   
  ...
  /**
   * Validate system audit history from the list
   * 
   * @param extentedReport
   * @param message
   * @return
   * @throws Exception
   */
  public boolean verifySystemAuditHistoryList(ExtentTest extentedReport, String[] message)
      throws Exception {
    try {
      boolean allMatched = false;
      int totalElement = message.length;
      ...
      GenericUtils.scrollIntoView(driver, tab_system_Audit_History);
      tab_system_Audit_History.click();
      for(int i=0;i<systemAuditRowCount.size();i++){      
        btnViewList.get(i).click();     
        GenericUtils.scrollIntoView(driver, txtpaneSystemAudit);
        String systemAuditDetail = txtpaneSystemAuditList.get(i).getText().toString();
        for (int j = 0; j < totalElement; j++) {
          if (systemAuditDetail.contains(message[j])) {
            totalMatched++;
            Log.message(
                message[j] + " - is present in the system audit detail - " + systemAuditDetail,
                driver, extentedReport);
          }
        }
      }   
   ...
   * @throws Exception
   */
  public void suspendUserGDPR(boolean Screenshot, ExtentTest extentReport,WebDriver driver) throws Exception {
    try {
      lnkEditDetails.click();
      WaitUtils.waitForElement(driver, txtLastName);
      Log.message("Clicked on Edit Details", driver, extentReport, Screenshot);
      suspendGDPRCheckbox.click();
//      WaitUtils.waitForElement(driver, gdprText);
      WaitUtils.waitForElementPresent(driver, gdprText, "Element is not present");
      WaitUtils.waitForelementToBeClickable(driver, editperson_Save, "Element is not clickable");
      editperson_Save.click();
    } catch (Exception e) {
      throw new Exception("Unable to Edit Customer Details : " + e);
    }
  ...
  /*
   * Click on Contact Edit Details button
   * 
   * @Author jheelum dutta
   */

  /**
   * Verify Manage contact details fields #C2__C1__BUT_58CF1F8E16D428CA38036
   * 
   * @return boolean
   * @throws Exception
   */
   ...
   * 
   */
  public void click_on_Edit_Details_link(ExtentTest extentedReport) throws Exception {
    try {
      final long startTime = StopWatch.startTime();
      WaitUtils.waitForElement(driver, link_con_details);
      JavascriptExecutor executor = (JavascriptExecutor) driver;
      executor.executeScript("arguments[0].click();", link_con_details);
      // btnSignIn.click();
      WaitUtils.waitForSpinner(driver);
      Log.message("Clicked on Edit Details Link   on customer Dashboard ", driver, extentedReport);
      Log.event("Clicked on Edit Details Link  on customer Dashboard ",
          StopWatch.elapsedTime(startTime));
    } catch (Exception e) {
      throw new Exception("Error while clicking on Edit Details Link  : " + e);
    }
  ...
  public void selecteRenewalVaration(ExtentTest extentedReport) throws Exception {

    try {
 
      WaitUtils.waitForSpinner(driver);
      WaitUtils.waitForElement(driver, btnRenewQotVariations);
      btnRenewQotVariations.click();
    
      WebElement menuToClick= driver.findElement(By.xpath(renewalquoteele));
      menuToClick.click();
      Log.message("Clicked on Renewal Variation one", driver, extentedReport);

      WaitUtils.waitForSpinner(driver);
      Log.message("Clicked on " + menuToClick, driver, extentedReport);
    
  }
    catch (Exception e) {
      throw new Exception("Unable to locate Renewal Variation one tab in customer dashboard page:" + e);
    }
  }

  
  public void suspendUserWithGDPR(WebDriver driver, ExtentTest extentedReport) throws Exception {

    try {
 
      WaitUtils.waitForSpinner(driver);
      WaitUtils.waitForElement(driver, tab_viewPolDetails);
      System.out.println("User routed back to Customer Dashbaord screen");
      WaitUtils.waitForElement(driver, editPersonalDetails);
