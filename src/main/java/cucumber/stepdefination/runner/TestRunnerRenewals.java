...
@CucumberOptions(plugin = {"pretty", "html:target/html/", "json:target/json/cc.json", "html:target/cucumber-html-report", "rerun:target/rerun.txt"},
    features = "src/main/java/resources", tags = "@test", monochrome = true, glue = "cucumber.stepdefination.runner")

public class TestRunnerRenewals extends AbstractTestNGCucumberTests {
