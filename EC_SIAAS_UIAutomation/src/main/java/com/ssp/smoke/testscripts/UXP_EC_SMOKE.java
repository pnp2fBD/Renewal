...
/*	@Test(description = "Create New Business 3* Policy - Annual Payment and search the created NB policy through normal policy search", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	public void TC_003(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(custdashboardpage.clickdocViewbtn(policyDetails.get("PolicyNo"), extentedReport),
...
/*	@Test(description = "Create New 5* Policy - Monthly Payment and verify document creation ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_004(String browser) throws Exception {
		...
		try {
			 ...
			 * // click the document tab custdashboardpage.clickDocuments(true,
			 * extentedReport);
			 * 
			 * // check for document generation Log.softAssertThat(
			 * custdashboardpage.verifyDocumentGeneration(DocumentnameNB,
			 ...
			 * 
			 * // check the attached document pdf/email
			 * Log.softAssertThat(custdashboardpage.clickdocViewbtn(policyDetails.get(
			 * "policyNo"), extentedReport),
			 * "Clicked on document view button and verified documents",
			 * "Clicked on document view button and documents not verified", driver,
	...
	public void TC_005(String browser) throws Exception {
		...
		try {
			 ...
			 * // click the document tab custdashboardpage.clickDocuments(true,
			 * extentedReport); // check for document generation Log.softAssertThat(
			 * custdashboardpage.verifyDocumentGeneration(DocumentnameCNL,
			 * policyDetails.get("Position"), extentedReport),
			 * "Documents are generated for 5 start policy",
			 * "Documents not generated for 5 start policy", driver, extentedReport, true);
			 * 
			 ...
			 * custdashboardpage.clickDocuments(true, extentedReport); // check for document
			 * generation Log.softAssertThat(
			 * custdashboardpage.verifyDocumentGeneration(DocumentnameRST,
			 * policyDetails.get("Position"), extentedReport),
			 * "Documents are generated for 5 start policy",
			 * "Documents not generated for 5 start policy", driver, extentedReport, true);
			 * 
	...
	public void TC_006(String browser) throws Exception {
		...
		try {
			 ...
			 * custdashboardpage.verifyDocumentGeneration(DocumentnameCNL,
			 * policyDetails.get("Position"), extentedReport),
			 * "Documents are generated for the policy",
	...
	public void TC_007(String browser) throws Exception {
		...
		try {
			 ...
			 * 
			 * // check for document generation Log.softAssertThat(
			 * custdashboardpage.verifyDocumentGeneration(DocumentnameMTA,
			 * policyDetails.get("Position"), extentedReport),
			 * "Documents are generated for MTA", "Documents not generated for MTA policy",
			 * driver, extentedReport, true);
			 * 
			 * // check the attached document pdf/email
			 * Log.softAssertThat(custdashboardpage.clickdocViewbtn(policyDetails.get(
	...
	public void TC_008(String browser) throws Exception {
		...
		try {
			...
			for (int i = 0; i < coversToAdd.length; i++) {
				...
				BoolVal = getquotepage.enterInsCoverDetails(testData, coversToRemove[i], ins_RowtoInteract, true,
						extentedReport);
	...
	public void TC_012(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					!newquotepage.verify_IntPartyName(
	...
	public void TC_014(String browser) throws Exception {
		...
		try {
			...
			Log.pass("Make  Call - Close button , Cancel button and outside pop up clicks works as expected",
					extentedReport);
			...
			homePage.clickAdminTask(extentedReport);
			homePage.clickOutsideBrandPopup(extentedReport, true);
			Log.pass("Admin Task - Close button , Cancel button and outside pop up clicks works as expected",
					extentedReport);
			Log.testCaseResult(extentedReport);
	...
	public void TC_017(String browser) throws Exception {
		...
		try {
			...
			getQuotePage.clickReCalculate(extentedReport);
			getQuotePage.clickBuy(extentedReport);
			getQuotePage.selectAvalilableAdjReasons(testData.get("AdjustmentReason"), extentedReport, false);
			getQuotePage.clickAddMTA(extentedReport, false);
			getQuotePage.clickAddAllMTANextButton(extentedReport, true);
			getQuotePage.takePayment(extentedReport);
			carddetailspage = getQuotePage.selectVisacard(extentedReport);
	...
	public void TC_018(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(custDashboardPage.showTabSectionsIfAvailable(sectionsLookingFor, extentedReport, false),
	...
	public void TC_023(String browser) throws Exception {
		...
		try {
            ...
            Log.softAssertThat(
                                            custdashboardPage.verifyContactName(
                                                                            CustomertestData.get("Title") + " " + CustomertestData.get("First Name") + " " + CustomertestData.get("Last Name"),
                                                                            extentedReport, true),
	...
	public void TC_027(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").equalsIgnoreCase("Accepted")) {
				 ...
				 * equalsIgnoreCase("ShortTermAdjustment ")) {
				 * 
				 * Log.pass("STA Policy Created Successfully in accepted status", driver,
				 * extentedReport, true);
				 * 
				 * } else { Log.
...
//				Log.softAssertThat(
//						getquotepage.validateReviewRenewalFields("Automatic Review", "Enabled", extentedReport, true),
//						"Automatic Review field is enabled", "Automatic Review field is not enabled", driver,
//						extentedReport);
//				Log.softAssertThat(
//						getquotepage.validateReviewRenewalFields("Automatic Renewal", "Enabled", extentedReport, true),
//						"Automatic Renewal field is enabled", "Automatic Renewal field is not enabled", driver,
//						extentedReport);
//				Log.softAssertThat(
//						getquotepage.validateReviewRenewalFields("Automatic Review", "checked", extentedReport, true),
//						"Automatic Review field is checked", "Automatic Review field is not checked", driver,
//						extentedReport);
//				Log.softAssertThat(
//						getquotepage.validateReviewRenewalFields("Automatic Renewal", "checked", extentedReport, true),
//						"Automatic Renewal field is checked", "Automatic Renewal field is not checked", driver,
//						extentedReport);

//				Log.softAssertThat(
//						!getquotepage.validateReviewRenewalFields("Block Renewal", "checked", extentedReport, true),
...
//						driver, extentedReport);
			...
			//	getquotepage.clickPolicyFlags("Block Renewal", extentedReport, true);
				Log.softAssertThat(getquotepage.validateReviewRenewalFields("Automatic Review", "disabled", extentedReport, true),
						"Automatic Review field is disabled", "Automatic Review field is not disabled", driver,
						extentedReport);
				Log.softAssertThat(
						getquotepage.validateReviewRenewalFields("Automatic Renewal", "disabled", extentedReport, true),
						"Automatic Renewal field is disabled", "Automatic Renewal field is not disabled", driver,
						extentedReport);
				
				Log.softAssertThat(
						getquotepage.validateReviewRenewalFields("Block Renewal", "disabled", extentedReport, true),
				...
				Log.softAssertThat(
						...
						extentedReport);
//				Log.softAssertThat(!getquotepage.validateReviewRenewalFields("Automatic Review", "checked", extentedReport, true)
...
//						extentedReport);
				...
				Log.softAssertThat(!getquotepage.validateReviewRenewalFields("Automatic Review", "checked", extentedReport, true),
						...
						extentedReport);
				Log.softAssertThat(!getquotepage.validateReviewRenewalFields("Automatic Renewal", "checked", extentedReport, true),
				...
				Log.softAssertThat(getquotepage.validateReviewRenewalFields("Block Renewal", "checked", extentedReport, true),
