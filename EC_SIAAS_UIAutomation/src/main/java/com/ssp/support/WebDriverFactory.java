...
public class WebDriverFactory {
        ...
        try {
            if ("chrome".equalsIgnoreCase(browser)) {
                ...
                if ("device".equalsIgnoreCase(test_type)) {
                    ...
                    String BS_browser = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("browser");
                    String BS_platform = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("os");
                    String BS_device = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("device");
                    ...
                    String BS_browser = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("browser");
                    String BS_browserVersion = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("browser_version");
                    String BS_os = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("os");
                    String BS_osVersion = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("os_version");
                ...
                driver = new RemoteWebDriver(new URL("https://" + driverHost + ":" + driverPort + "@hub-cloud.browserstack.com/wd/hub"), caps);
                ...
                synchronized (WebDriverFactory.class) {
                    ...
                    //firefoxCapabilities.setCapability("browserstack.local", "true");
                   firefoxCapabilities.setCapability("os", "Windows");
                   firefoxCapabilities.setCapability("os_version", "7");
    ...
    public static final String getTestSessionNodeIP(final WebDriver driver) throws Exception {
        ...
        URL testSessionApi = new URL("https://" + driverHost + ":" + driverPort + "/grid/api/testsession?session=" + ((RemoteWebDriver) driver).getSessionId());
