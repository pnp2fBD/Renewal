...
public class UnsuspendBillingPage extends LoadableComponent<UnsuspendBillingPage> {
	...
	public CustDashboardPage selectDirectDebitGuarantee(ExtentTest extentedReport, boolean screenshot)
		...
		try {
			...
			btnAccept.click();
			WaitUtils.waitForSpinner(driver);
			Log.message("Accept button is clicked after DriectDebit gaurantee checkbox is selected", driver,
	...
	public void clickTakePaymentBtn(ExtentTest extentedReport) {
		...
		WaitUtils.waitForElementPresent(driver, btnTakePayment, "Take Payment button is not found in Unsuspend billing page");
	 ...
	 * 
	 */
	public void enterCardNumber(HashMap<String, String> testdata, ExtentTest extentReport, boolean Screenshot)
			throws Exception {
		WaitUtils.waitForElement(driver, txtCardNumber);
		try {
			txtCardNumber.clear();
			txtCardNumber.sendKeys(testdata.get("Card Number"));
			Log.message("Entered Card Number : " + testdata.get("Card Number"), driver, extentReport, Screenshot);
		} catch (Exception e) {
	 ...
	 * 
	 */
	public void selectExpiry(HashMap<String, String> testdata, ExtentTest extentReport, boolean Screenshot)
			throws Exception {
		try {
	 ...
	 * 
	 */
	public void enterName(HashMap<String, String> testdata,ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			
			txtCardHoldName.sendKeys("First Name");
			Log.message("Entered Card Holder Name : "+testdata.get("First Name"), driver, extentReport, Screenshot);
		} catch (Exception e) {
	 ...
	 * 
	 */
	public void selectYear(HashMap<String, String> testdata, ExtentTest extentReport) throws Exception {
		try {
	...
	public CustDashboardPage clickConfirmBtn(ExtentTest extentedReport) {
		WaitUtils.waitForElementPresent(driver, btnConfirm, "Confirm button is not found in Unsuspend billing page");
		btnConfirm.click();
