...
public class NewQuotePage extends LoadableComponent<NewQuotePage> {
	...
	public final String ERROR_MSG_PAYOR_ALLFIELDS = "Please enter a Lastname, Firstname, and either a Date of Birth or Postcode";
	public final String ERROR_MSG_PAYOR_POSTCODE_OR_DOB = "Please enter either a Date of Birth or Postcode";
	public final String ERROR_MSG_PAYOR_LASTNAME = "Please enter a Lastname";
	public final String ERROR_MSG_ADD_ACCOUNT_DETAILS = "Please enter valid sort code and account number";
	...
	public String radAgree =  "#C2__p4_QUE_921BCE84FE9FC3B2469614 div:nth-child(1) > label[for='C2__QUE_921BCE84FE9FC3B2469614_0']";
	public String impDocuments = "div[id*='FMT_3661A386F2BF3E141531426']>div>div[id*='BUT_712BAE31A6D7FEBA1490274']>div>div>div>label";
	...
	public String txtmsg_unknwn_error = "div[id*='FMT_9E775789D61887FF4424404']>div>div>div>div>div>div.col-md-11";
	...
	public String addInterestSearchResultPane = "div#C2__FMT_E36EFB44BDE033C56426563.modal-body.clearfix.errormsg_position";
	...
	public String firstCheckOfPolicyHolderTable = "input[type='checkbox'][id*='C2__QUE_65369060E37BB4AE3541860_0_R1']";
	...
	public String xpathAccSelectBtnOfAccDetails = "//table[@summary='BankDetails']//tr[.//span[text()='${SORT_CODE}']][.//span[text()='${BRANCH}']][.//span[text()='${ACC_NAME}']][.//span[text()='${ACC_NO}']]//button";
	...
	@FindBy(css = "input[name='C2__CONTACTCENTRE[1].BUYQUOTE[1].DIRECTDEBITS[1].ACCOUNTDETAILS[1].SORTCODE']")
	...
	@FindBy(css = "input[name='C2__CONTACTCENTRE[1].BUYQUOTE[1].DIRECTDEBITS[1].ACCOUNTDETAILS[1].ACCOUNTNAME']")
	...
	@FindBy(css = "#C2__p4_QUE_921BCE84FE9FC3B2469614 div:nth-child(1) > label[for='C2__QUE_921BCE84FE9FC3B2469614_0']")
	...
	@FindBy(css = "select[name='C2__CONTACTCENTRE[1].GETQUOTE[1].POLICYCONTACTS[1].INTERESTEDPARTYOVERLAY[1].CONTACTTYPE")
	WebElement addInterestcontactType;

	@FindBy(css = "input[name='C2__CONTACTCENTRE[1].GETQUOTE[1].POLICYCONTACTS[1].INTERESTEDPARTYOVERLAY[1].SEARCHCONTACTSECONDNAME']")
	WebElement addInterestFirstname;

	@FindBy(css = "input[name='C2__CONTACTCENTRE[1].GETQUOTE[1].POLICYCONTACTS[1].INTERESTEDPARTYOVERLAY[1].SEARCHFORCONTACT']")
	...
	@FindBy(css = "select[name='C2__CONTACTCENTRE[1].GETQUOTE[1].POLICYCONTACTS[1].INTERESTEDPARTYOVERLAY[1].INTERESTEDPARTYTYPE']")
	...
	@FindBy(css = "input[name*='CORPORATE[1].AUTHORISEDCONTACTDETAILS[1].AUTHORISEDTELEPHONENUMBERS[1].HOME']")
	WebElement txtAuthphoneHome;

	@FindBy(css = "input[name*='CORPORATE[1].AUTHORISEDCONTACTDETAILS[1].AUTHORISEDTELEPHONENUMBERS[1].WORK']")
	WebElement txtAuthphonework;
	@FindBy(css = "input[name*='.CORPORATE[1].AUTHORISEDCONTACTDETAILS[1].AUTHORISEDTELEPHONENUMBERS[1].MOBILE']")
	WebElement txtAuthphoneMob;
	@FindBy(css = "input[name*='CORPORATE[1].AUTHORISEDCONTACTDETAILS[1].AUTHORISEDTELEPHONENUMBERS[1].EMAIL']")
	...
	@FindBy(css = "input[name='C2__CONTACTCENTRE[1].GETQUOTE[1].POLICYCONTACTS[1].INTERESTEDPARTYOVERLAY[1].POSTCODE'")
	...
	@FindBy(css = "input[name='C2__CONTACTCENTRE[1].YOURDETAILS[1].HOME[1].COVERSTARTDATE_READONLY'][readonly='readonly]")
	 ...
	 * 
	 */
	public void enterPolicyDetails(HashMap<String, String> testdata, boolean Screenshot, ExtentTest extentReport)
			throws Exception {
		...
		try {
			...
			Thread.sleep(3000);
			Log.message("Property Type chosen : " + testdata.get("Property Type").toString(), extentReport);
	 ...
	 * 
	 */
	public void enterCustomerDetails(HashMap<String, String> testdata, boolean Screenshot, String Corecover,
	...
	public void clickView(ExtentTest extentReport) throws Exception {
		try {
			...
			(new WebDriverWait(driver, 4000).pollingEvery(200, TimeUnit.MILLISECONDS)
					...
					.withMessage("Unable to find view button")).until(ExpectedConditions.elementToBeClickable(btnView));
	...
	public void clickRenewalQuoteBuy(ExtentTest extentedReport, String... buyType) throws Exception {
		try {
			...
			throw new Exception("Unable to Click on Renewal Buy Button - Premium values could be zero :" + e);
		}
	}
	...
	public boolean verifyStoredBankDetailsListed(String branchName, HashMap<String, String> testdata,
		...
		boolean status = false;
		WaitUtils.waitForElementPresent(driver, but_AddAccDetail, "Add Account detail button is not found");
		...
		if (tableAccDetailsBranch.getText().equals(branchName))
			status = true;
		Log.message("Account Branch Name is :" + tableAccDetailsBranch.getText(), driver, extentedReport, Screenshot);
		return status;
	...
	public void clickTerms(ExtentTest extentedReport) throws Exception {
		try {
			...
			Log.message("Selected Terms and Conditions and click next button sucessfully", driver, extentedReport);
			WaitUtils.waitForSpinner(driver);
		} catch (Exception e) {
	...
	/**
	 * Description : click TermsAndCondition button of TermsAndCondition section
	 * in acceptance page
	 * 
	 * @param extentedReport
	 * 
	...
	/**
	 * Fills up Payment section input fields with the given test data and checks
	 * the 'Customer agrees ...' checkbox.
	 * 
	 * @param testData
	 * @param Screenshot
	 * @param extentedReport
	 * @throws Exception
	 */
	public void selectPayment(HashMap<String, String> testData, boolean Screenshot, ExtentTest extentedReport)
			throws Exception {
		try {
	...
	public void clickAddAccountDetails(ExtentTest extentedReport) {
		WaitUtils.waitForElementPresent(driver, btnAddAccDetail, "Add Account detail button is not found");
		btnAddAccDetail.click();
		Log.message("Clicked 'Add Account Details' button", extentedReport);
	}

	/**
	 * Clicks on 'Check Account' button after writing the given account number
	 * and sort code in the 'Account Number' and 'Sort Code' input fields
	 * respectively.
	 * 
	 * @param accountNumber
	 * @param sortCode
	...
	public void checkBankAccount(String accountNumber, String sortCode, ExtentTest extentedReport) {
		...
		((JavascriptExecutor) driver)
				.executeScript("document.getElementById('C2__QUE_EE2C7D9B8CC571FB1355410').value='09-01-26';");
	...
	/**
	 * Verifies that the actual error message in 'Add Account Details' matches
	 * the expected error message given.
	 * 
	 * @param expectedErrMsg
	 * @param extentedReport
	 * @return true if the actual error message matches the expected error
	 *         message given; false otherwise.
	 */
	public boolean verifyAddAccountDetailsErrorMessage(String expectedErrMsg, ExtentTest extentedReport) {
	 ...
	 * @param extentedReport
	 * @return true if the actual sort code matches the expected sort code
	...
	public boolean verifySortCode(String expectedSortCode, ExtentTest extentedReport) {
		...
		if (actualSortCode.equals(expectedSortCode)) {
			...
			Log.message("The actual sort code '" + actualSortCode + "' does not match the expected '" + expectedSortCode
					+ "'", extentedReport);
		}
	...
	/**
	 * Verifies that the actual branch name matches the expected branch name
	 * given.<br/>
	 * <br/>
	 ...
	 * @param extentedReport
	 * @return true if the actual branch name matches the expected branch name
	 *         given and the field is not editable; false otherwise.
	 */
	...
	/**
	 * Verifies that the actual account name matches the expected account number
	 * given.
	 * 
	 * @param expectedAccName
	 * @param extentedReport
	 * @return true if the actual account name matches the expected account name
	 *         given; false otherwise.
	 */
	...
	/**
	 * Verifies that the actual account number matches the expected account
	 * number given.
	 * 
	 * @param expectedAccNo
	 * @param extentedReport
	 * @return true if the actual account number matches the expected account
	 *         number given; false otherwise.
	 */
	 ...
	 * @param screenshot
	 */
	public void selectAccount(String sortCode, String branch, String accName, String accNo, ExtentTest extentedReport,
		...
		WaitUtils.waitForElementPresent(driver, "xpath", xpathAccSelect, 30,
				"Timed out to find the 'select' button of account with following details {sort code: '" + sortCode
						+ "', branch: '" + branch + "', account name: '" + accName + "', account number: '" + accNo
						+ "'}");
		...
		WaitUtils.waitForElementAbsent(driver, "xpath", xpathAccSelect, 30,
				"Timed out waiting for the absence of the 'select' button of account with following details {sort code: '"
						+ sortCode + "', branch: '" + branch + "', account name: '" + accName + "', account number: '"
						+ accNo + "'}");
		Log.message("Clicked on the select button of account with account name '" + accName + "'", driver,
				extentedReport, true);
	}

	/**
	 * Verifies all the fields in the 'Account Details' section and returns the
	 * verification status.
	 * 
	 * @param sortCode
	 * @param branch
	 ...
	 * @param accNo
	 * @param extentedReport
	 * @return true if all the fields in the 'Account Details' section are
	 *         successfully verified; false otherwise.
	 */
	public boolean verifyAccountDetails(String sortCode, String branch, String accName, String accNo,
		...
		if (verifySortCode(sortCode, extentedReport) && verifyBranchName(branch, extentedReport)
				&& verifyAccountName(accName, extentedReport) && verifyAccountNumber(accNo, extentedReport)) {
			isOk = true;
		}
	...
	/**
	 * Verifies that the 'Select' button of the selected account is hidden and
	 * the 'Account Details' fields are populated with the selected account
	 * details.
	 * 
	 * @param sortCode
	 * @param branch
	 ...
	 * @param accNo
	 * @param extentedReport
	 * @return true if the 'Select' button of the selected account is hidden and
	 *         the selected account details are successfully verified; false
	 *         otherwise.
	 */
	public boolean verifyAccountSelection(String sortCode, String branch, String accName, String accNo,
			ExtentTest extentedReport) {
		boolean isOk = false;
	 ...
	 * @throws Exception
	 */
	public void selectPreferredPaymentDay(String day, ExtentTest extentReport, boolean screenshot) throws Exception {
		try {
			...
			WaitUtils.waitForSpinner(driver);
			Log.message("Perferred Payment day is selected as - " + day, driver, extentReport, screenshot);
		} catch (Exception e) {
	...
	/**
	 * Verifies that the actual error message in 'Account Details' section
	 * matches the expected error message given.
	 * 
	 * @param expectedErrMsg
	 * @param extentedReport
	 * @return true if the actual error message matches the expected error
	 *         message given; false otherwise.
	 */
	public boolean verifyAccountDetailsErrorMessage(String expectedErrMsg, ExtentTest extentedReport) {
	...
	/**
	 * Verifies that the actual error message in 'Account Details' section
	 * matches the expected error message given, when no account details are
	 * added.
	 * 
	 * @param expectedErrMsg
	 * @param extentedReport
	 ...
	 *         message given; false otherwise.
	 */
	public boolean verifyNoAccountDetailsErrorMessage(String expectedErrMsg, ExtentTest extentedReport) {
	 ...
	 */
	public boolean verifyPaymentScheduleTable(HashMap<String, String> testData, ExtentTest extentedReport,
			boolean screenshot) {
		boolean isOk = false;
		String[] expectedColHeader = { "Due", "Calculated Premium", "Taxes", "Charges", "Charges Tax", "Instalments",
				"Amount Payable" };
		...
		if (actualColHeaderSize != expectedColHeaderSize) {
			Log.message("The total number of actual colum headers is unexpected. Expected: <" + expectedColHeaderSize
					+ ">; Actual: <" + actualColHeaderSize + ">", extentedReport);
		} else {
		...
		for (int i = 0; i < expectedColHeaderSize; i++) {
			...
			if (!isColumnOk) {
				Log.message(
						"The column '" + columnName + "' of 'Payment Schedule' table does not have the expected data",
						extentedReport);
			}
		 ...
		 * 
		 * All footers except at position 1 are covered during table data
		 * verification
		 */
		...
		if (!isFooterOk) {
			Log.message("The actual footer '" + actualFooter1 + "' of column #1" + " does not match the expected '"
					+ expectedFooter1 + "'", extentedReport);
		}
	 ...
	 * @param extentedReport
	 * @param screenshot
	 * @return true if the data in the given column are as expected; false
	 *         otherwise.
	 */
	public boolean verifyPaymentScheduleColumn(String columnName, HashMap<String, String> testData,
		...
		if (columnName.equals("Due")) { // #1
			int preferredPaymentDay = Integer
					.parseInt(testData.containsKey("Preferred Payment Day") ? testData.get("Preferred Payment Day")
							: DateTimeUtility.getCurrentDate().split("/")[0]);
			...
			for (int i = 0; i < totalInstallments; i++) {
				...
				if (i == 0) {
					isOkFirstPayment = String.format("%.2f", actualCalculatedPremium).equals(firstPaymentAcceptanceTab);
					if (!isOkFirstPayment) {
						Log.message(
					...
					if (i > 1 && !isOkInstallmentPayment) {
						...
						if (!isOkInstallmentPayment) {
							Log.message("actualCalculatedPremium: [" + String.format("%.2f", actualCalculatedPremium)
			...
			for (int i = 0; i < totalInstallments; i++) {
				...
				if (i == 0) {
					Log.message("Row No: [" + (i + 1) + "]; Expected Amount Payable: [" + firstPaymentAcceptanceTab
							+ "]; Actual Amount Payable: [" + String.format("%.2f", actualAmountPayable)
							+ "]; Sum of Amount Payable: [" + String.format("%.2f", expectedTotalAmountPayable) + "]",
							extentedReport);
					isOkFirstPayment = String.format("%.2f", actualAmountPayable).equals(firstPaymentAcceptanceTab);
				} else {
					...
					if (i > 1 && !isOkInstallmentPayment) {
						...
						isOkInstallmentPayment = String.format("%.2f", actualAmountPayable)
								.equals(installmentPaymentAcceptanceTab);
					}
				}
			}
	...
	/**
	 * Returns the <i>testData</i> <code>HashMap</code> with payment details
	 * grabed from Cover tab.
	 * 
	 * @param testData
	 * @param extentedReport
	 * @param screenShot
	 * @return the <code>HashMap</code> representation of testData, or null if
	 *         no <code>HashMap</code> representation is applicable
	 * @throws Exception
	 */
	public HashMap<String, String> grabPaymentDetailsFromCoverTab(HashMap<String, String> testData,
		...
		String installmentPaymentCoverTab = spnInstallmentPaymentCoverTab.getText().replaceFirst("£", "").trim();
		...
		Log.message("Cover Tab Payment Details:- One-Off Payment: [" + oneOffPaymentCoverTab + "]; Total Payment: ["
				+ totalPaymentCoverTab + "]; First Payment: [" + firstPaymentCoverTab + "]; Installment Payment: ["
				+ installmentPaymentCoverTab + "]", extentedReport);

		return testData;
	}

	/**
	 * Verifies that the payment details available at Acceptance tab matches the
	 * payment details grabed from Cover tab.
	 * 
	 * @param testData
	 * @param extentedReport
	 * @param screenShot
	 * @return true if the payment details available at Acceptance tab are as
	 *         expected; false otherwise.
	 * @throws Exception
	 */
	public boolean verifyPaymentDetailsAtAcceptanceTab(HashMap<String, String> testData, ExtentTest extentedReport,
			boolean screenShot) throws Exception {
		boolean isOk = false;
	 ...
	 * @param expectedFee
	 * @param extentedReport
	 * @return true if the actual includes fee matches the expected fee given;
	 *         false otherwise.
	 */
	...
	public void clickPaymentOptionBar(ExtentTest extentedReport, boolean screenshot) throws Exception {
	...
	public void clickMidTermAdjustment(ExtentTest extentedReport) throws Exception {
		try {
			...
			Log.message("Clicked on Mid Term Adjustment after upgrading policy", driver, extentedReport, true);
		} catch (Exception e) {
	 ...
	 * 
	 */
	public void doEligibilityCheck(HashMap<String, String> testdata, boolean Screenshot, ExtentTest extentedReport)
			throws Exception {
		try {
	 ...
	 * 
	 */
	public void validationCheck(HashMap<String, String> testdata, boolean Screenshot, ExtentTest extentedReport)
			throws Exception {
		try {
			enterAccountHolder(testdata.get("First Name").toString());
			Log.message("Entered account holder name :" + testdata.get("First Name").toString(), extentedReport);
			...
			Log.message("Entered account number :" + testdata.get("Account Number").toString(), extentedReport);
			validateAccount();
	 ...
	 * @throws Exception
	 */
	public CustDashboardPage confirmPayment(HashMap<String, String> testdata, ExtentTest extentedReport)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public CustDashboardPage rnlconfirmPayment(HashMap<String, String> testdata, ExtentTest extentedReport)
			throws Exception {
		CustDashboardPage objCustDashboardPage = null;
		try {
			String paymentplan = testdata.get("Payment Plan");
	...
	public void selectRevTransacType(String revTransacType, ExtentTest extentedReport) throws Exception {
		try {
	...
	public void ValidateDocuments(ExtentTest extentedReport) throws Exception {
		try {
			...
			Thread.sleep(20000);
			List<String> docList = Arrays.asList("Pre-Contractual Agreement:", "Representative Example:",
					"DD Mandate:");
			...
			for (int j = 0; j < docList.size(); j++) {
				...
				for (int i = 0; i < docOptions.size();) {
					...
					System.out
							.println("Values are printed here in  actual:  Expected" + doc_Name + ":" + docList.get(j));
					docPresence = true;
					break;
				}
			...
			if (docPresence1) {
				Log.message("Verified the three monthly policy documents visible ", driver, extentedReport, true);
			} else {
				Log.fail("Step-12:Three monthly policy documents are not visible", driver, extentedReport, true);
			}
	 ...
	 *            :boolean
	 */
	public String getDefaultVals_InsCovers(String testDataToCheck, boolean screenshot, ExtentTest extentedReport)
			throws Exception {
		...
		try {
			...
			case "BLD":
				...
				System.out.println(
						"Limit and Excess amount of BLD cover is: LimitVal " + Lmt_Val + ",ExcessValue:" + exces_Val);
				if ((Lmt_Val.equals(Exp_limit_Amt)) && (exces_Val.equals(Exp_Acess_Amt))) {
					valToReturn = "BLD Cover : LimitAmt =" + Lmt_Val + ", ExcessAmt =" + exces_Val;
				} else
					Log.message("Default amount were not populated for BLD Cover, it displayed : LimitAmt =" + Lmt_Val
							+ ", ExcessAmt =" + exces_Val, driver, extentedReport, true);
				break;
			...
			case "CNT":
				...
				System.out.println(
						"Limit and Excess amount of CNT cover is: LimitVal " + Lmt_Val + ",ExcessValue:" + exces_Val);
				if ((Lmt_Val.equals(Exp_limit_Amt)) && (exces_Val.equals(Exp_Acess_Amt))) {
					...
					// extentedReport, true);
					Log.message("Default amount were not populated for CNT Cover, it displayed : LimitAmt =" + Lmt_Val
							+ ", ExcessAmt =" + exces_Val, driver, extentedReport, true);
				break;
			...
			case "PI":
				...
				System.out.println(
						"Limit and Excess amount of CNT cover is: LimitVal " + Lmt_Val + ",ExcessValue:" + exces_Val);
				if ((Lmt_Val.equals(Exp_limit_Amt)) && (exces_Val.equals(Exp_Acess_Amt))) {
					valToReturn = "PersonalItems Cover : LimitAmt =" + Lmt_Val + ", ExecessAmt =" + exces_Val;
				} else
					Log.message("Default amount were not populated for Personal items cover", driver, extentedReport,
							true);
				break;
			}
			...
			throw new Exception("Unable to get the default values from BLD& CNT section. Exception occured: " + e);
		}
	...
	public String SelectInsuranceItem(String coverDetails, boolean screenshot, ExtentTest extentedReport)
		...
		try {
			...
			throw new Exception("Unable to Click on " + addRemove + " Button to add covers " + e.getMessage());
		}
	 ...
	 *            :boolean
	 */
	public boolean enterInsCoverDetails(HashMap<String, String> testData, String InscoverToAdd, String RowToInteract,
		...
		try {
			...
			throw new Exception("Unable to " + addRemovebuton + " " + coverType + "_" + InscoverToAdd.split("_")[1]
					+ "cover details. Exception occured: " + e);
		}
	 ...
	 *            :boolean
	 */
	public boolean enter_BLDCoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
			...
			if (AddRem.equalsIgnoreCase("Add")) {
				...
				String strPopName = ins_BLDCover_EditPopUp.findElement(By.className("modal-title")).getText();
				if (strPopName.equalsIgnoreCase(coverType)) {
					WebElement ele_BldExces = ins_BLDCover_EditPopUp
							.findElement(By.cssSelector(ins_BldCover_excessAmt));
			...
			throw new Exception(
					"Unable to " + AddRem + " " + coverType + "cover details. Exception occured: " + e.getMessage());
		}
	}
	 ...
	 *            :boolean
	 */
	public boolean enter_ADCoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
	 ...
	 *            :boolean
	 */
	public boolean enter_HRCoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
			String eletoInteract = RowToInteract + ":nth-child(3)>td:nth-child(3)";
			if (AddRem.equalsIgnoreCase("Add")) {
				WaitUtils.waitForElementPresent(driver, ins_HRcoverPopUp, "Unable to find the High Risk covers popup");
				...
				if (strPopName.equalsIgnoreCase(coverType)) {
					...
					Thread.sleep(2000);
					WaitUtils.waitForElementPresent(driver, ins_HR_SaveBut, "Unable to Save button on HR pop up");
	 ...
	 *            :boolean
	 */
	public boolean enter_GCCoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
			String eletoInteract = RowToInteract + ":nth-child(4)>td:nth-child(3)";
			if (AddRem.equalsIgnoreCase("Add")) {
				WaitUtils.waitForElementPresent(driver, ins_GCcover_PopUp, "Unable to find the Gardencovers popup");
	 ...
	 *            :boolean
	 */
	public boolean enter_TECoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
			String eletoInteract = RowToInteract + ":nth-child(5)>td:nth-child(3)";
			if (AddRem.equalsIgnoreCase("Add")) {
				WaitUtils.waitForElementPresent(driver, ins_TEcover_Popup, "Unable to find the Gardencovers popup");
				...
				WaitUtils.waitForinvisiblityofElement(driver, 300, spinner,
						"Unable to Switch to Windows after " + AddRem + "ing Technology and Entertainment cover");
				String excess_Val = driver.findElement(By.cssSelector(eletoInteract)).getText();
				System.out.println("Value is " + excess_Val);
				if (excess_Val == "") {
					BoolVal = true;
	 ...
	 *            :boolean
	 */
	public boolean enter_PIcoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
			String eletoInteract = RowToInteract + ":nth-child(6)>td:nth-child(3)";
			if (AddRem.equalsIgnoreCase("Add")) {
				WaitUtils.waitForElementPresent(driver, ins_PIcover_Popup, "Unable to find the Personal Items popup");
	 ...
	 *            :boolean
	 */
	public boolean enter_PCcoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
			WaitUtils.waitForSpinner(driver);
			...
			if (AddRem.equalsIgnoreCase("Add")) {
				WaitUtils.waitForElementPresent(driver, ins_PCcover_Popup, "Unable to find the Pedal cycles popup");
				...
				if (strPopName.equalsIgnoreCase("Unspecified Bicycles")) {
					...
					if (ins_PCcover_Specified_cyclecount.isDisplayed()) {
						...
						/*
						 * actions = new Actions(driver);
						 * actions.moveToElement(ins_PCcover_value).click();
						 * actions.sendKeys(testData.get(
						 * "PC_specifiedItems_coverAmt").toString());
						 * Thread.sleep(2000);
						 * actions.sendKeys(Keys.RETURN).build().perform();
						 */
						/*ins_PCcover_Description.click();
						ins_PCcover_Description.sendKeys(Keys.TAB);*/
	 ...
	 *            :boolean
	 */
	public boolean enter_HEcoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
			WaitUtils.waitForinvisiblityofElement(driver, 300, spinner,
			...
			String eletoInteract = RowToInteract + ":nth-child(1)>td:nth-child(3)";
			if (AddRem.equalsIgnoreCase("Add")) {
				WaitUtils.waitForElementPresent(driver, btnDashboard, "Unable to find the Home emergency row");
	 ...
	 *            :boolean
	 */
	public boolean enter_LEcoverDetails(HashMap<String, String> testData, String coverType, String AddRem,
			String RowToInteract, boolean screenshot) throws Exception {
		try {
			boolean BoolVal = false;
			WaitUtils.waitForinvisiblityofElement(driver, 300, spinner,
			...
			if (AddRem.equalsIgnoreCase("Add")) {
				WaitUtils.waitForElementPresent(driver, btnDashboard, "Unable to find the Legal emergency row");

				WaitUtils.waitForElementPresent(driver, driver.findElement(By.cssSelector(elementtoInteract)),
		...
		try {
			...
			for (int i = 0; i < buttonOptions.size(); i++) {
				...
				if (radio_button_value.contains(option)) {
					...
					/*
					 * Actions actions = new Actions(driver);
					 * actions.moveToElement(buttonOptions.get(i)).click().build
					 * ().perform();
					 */
					// ((JavascriptExecutor)
	...
	public void clickAddParties(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			...
			WaitUtils.waitForElementPresent(driver, 180, addInterestedPartyBtn, "AddParties button is not visible");
			...
			if (WaitUtils.waitForElement(driver, modal_IntParty))
				Log.message("Add interested party modal opened after clicking Add Interested party", extentReport);
	...
	public void Select_InterstedParty(HashMap<String, String> testData, ExtentTest extentReport, boolean Screenshot)
			throws Exception {
		WaitUtils.waitForElementPresent(driver, 180, modal_IntParty, "Interested party pop up has failed to open");
		try {
			if (dropdown_IntParty.getText().contains("Please select"))
				Log.message("Has the default value as 'Please select' in contact type drop down field", extentReport);
			else
			...
			Log.message("Selected contact type for interested party :" + testData.get("InterestedParty"), extentReport);
			...
			if (testData.get("InterestedParty").equalsIgnoreCase("1")) {
				...
				String str_UsrNam = table_IP.get(0).findElements(By.cssSelector("td>div>span")).get(0).getText();
				...
				if (txt_IntPartCorp_lName.isDisplayed() && txt_IntPartCopr_Pcode.isDisplayed())
					...
					Log.fail("Failed to display contact field and post code fields for corporate contact Int Party",
							extentReport);
	...
	public void validatemsgonIntPar(ExtentTest extentReport, boolean Screenshot) throws Exception {
		...
		try {
			if (txtmsg_warnIP.getText().equalsIgnoreCase(
				...
				;
			Log.message("Interesparty window has the expected warning message displayed as: " + txtmsg_warnIP.getText(),
					extentReport);
		} catch (Exception e) {
			throw new Exception(
	...
	/**
	 * To input values(from/to)of interesparty after selecting the party from
	 * search results
	 * 
	 * @param extentReport
	 * @param Screenshot
	...
	public void EnterIntPartype(ExtentTest extentReport, boolean boolEnterDate, boolean Screenshot) throws Exception {
		...
		String strDate = formDate.format(new Date());
		Thread.sleep(2000);
		WaitUtils.waitForelementToBeClickable(driver, datePicker_To, "Unable to enter date in To date field");
		if (boolEnterDate)
			datePicker_To.sendKeys(strDate);
		datePicker_To.click();*/
	...
	public void checkAddPartyModalPanes(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			WaitUtils.waitForSpinner(driver);
			...
			if (addPartyPane.isDisplayed() && searchPane.isDisplayed())
				Log.message("Both Add Interested party pane and Search pane present ", driver, extentReport);
			else
	...
	public void checkAddPartymodalPanefields(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			WaitUtils.waitForSpinner(driver);
			...
			WebElement expectedWebElement3 = driver.findElement(By.cssSelector(addInterestsearchforContact));
			if (expectedWebElement1.isDisplayed() && expectedWebElement3.isDisplayed() && but_IP_cancel.isDisplayed())

				Log.message("Add Interested Party window has the expected fields : Contact type and Cancel button",
	 ...
	 * 
	 */
	public void checkAddPartySearchResultsPane(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
	...
	public void AIenterFirstName(String Firstname, ExtentTest extentReport) throws Exception {
		try {
			...
			WaitUtils.waitForelementToBeClickable(driver, addInterestFirstname, "Interested party first name field was not clickable");
	...
	public void clickselect(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			WaitUtils.waitForelementToBeClickable(driver, addInterestselecthBtn, "Unable to click select");
	...
	public void addInterestedPartyType(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			WaitUtils.waitForelementToBeClickable(driver, addInterestpartytype, "Unable to select interestedPartyType");
	 ...
	 *            :boolean
	 */
	public void addInterestedPartyClickSave(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			Thread.sleep(2000);
	...
	/**
	 * To verify delete icon on price presentation page in interested party
	 * section
	 * 
	 * @param extentReport
	 * @param Screenshot
	...
	public void click_Deleteicon(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			WaitUtils.waitForElementPresent(driver, 360, addPartyDeleteicon, "Delete icon is not present");
	...
	public void verifyRemoveModal(ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			WaitUtils.waitForElementPresent(driver, deletepopupmodal, "Remove warning popup has not opened");
	...
	public void selectGardenCoverLimit(String GardenCoverLimit, ExtentTest extentedReport) throws Exception {
		try {
	...
	public void selectPolicyCancelReason(String PolicyCancelReason, ExtentTest extentedReport) throws Exception {
		try {
	...
	public void selectPolicyCancelReturn(String PolicyCancelReturn, ExtentTest extentedReport) throws Exception {
		try {
	...
	/**
	 * To check the yes /no button on remove description when bin icon clicked
	 * in interested party
	 * 
	 * @throws Exception
	 * @param extentReport
	...
	public void clickQuoteSave(String typeOfQuote, String txtToenter, ExtentTest extentedReport) throws Exception {
		try {
			WaitUtils.waitForSpinner(driver);
			...
			case "NB":
				...
				if (WaitUtils.waitForElement(driver, btnContinueSaveQuote)) {
					...
					Log.message("Entered Email address and clicked on Continue button : " + txtToenter, driver,
							extentedReport);
					Thread.sleep(2000);
					WaitUtils.waitForSpinner(driver);
				}
	 ...
	 * <br/>
	 * The vararg '<i>shouldForceRandomNameCreation</i>' of the method is used
	 * to tell whether the random name (both first name and last name) should be
	 * entered in form despite the name value given in <i>testData<i/>.
	 * 
	 * @param testData
	 * @param screenShot
	 * @param extendReport
	 ...
	 */
	/*
	 * public HashMap<String, String> enterCustomerDetails(HashMap<String,
	 * String> testData, boolean screenShot, ExtentTest extendReport, boolean...
	 * shouldForceRandomNameCreation) throws Exception { try {
	 ...
	 * enga_Centre_tabs_Personal.click(); Thread.sleep(2000); }
	 * 
	 * boolean forceRandomValueFlag = shouldForceRandomNameCreation.length > 0 ?
	 * shouldForceRandomNameCreation[0] : false; String title =
	 * testData.get("Title").toString(); String firstName =
	 * testData.get("First Name").toString(); String lastName =
	 * testData.get("Last Name").toString(); String dob =
	 * testData.get("Date of Birth").toString(); String gender =
	 * testData.get("Gender").toString(); String postcode =
	 * testData.get("Post Code").toString(); String homephone =
	 * testData.get("Home Phone").toString(); String email =
	 * testData.get("Email").toString();
	 * 
	 * Log.message("Entering Customer details"); selectTitle(title);
	 ...
	 * 
	 * entercn_LastName(lastName); testData.put("Last Name", lastName);
	 * Log.message("Last Name : " + lastName, extendReport);
	 * 
	 * entercn_DateOfBirth(dob); Log.message("Date of Birth : " + dob,
	 * extendReport); Thread.sleep(2000);
	 * 
	 * selectGender(gender); Log.message("Gender : " + gender, extendReport);
	 * 
	 * entercn_PostCode(postcode); Log.message("Post Code : " + postcode,
	 * extendReport);
	 * 
	 * entercn_HomePhone(homephone); Log.message("Home Phone : " + homephone,
	 * extendReport);
	 * 
	 * if (!email.contains("@")) email = testData.get("Email") +
	 * DateTimeUtility.getTimeIn_MMSS() + "IntParty@ectest.com";
	 * 
	 * cn_Email.clear(); cn_Email.sendKeys(email);
	 * 
	 * Log.message("Email : " + email, extendReport); testData.put("Email",
	 * email);
	 * 
	 * selectRadioButton(radPreferences, "Email");
	 * 
	 * Log.message("Sucessfully entered the Customer details", driver,
	 * extendReport, screenShot);
	 * 
	 * } catch (Exception e) { throw new
	 * Exception("Exception entering the customer details. " + e); } return
	 * testData; }
	 */

	public HashMap<String, String> enterCustomerDetails(HashMap<String, String> testData, boolean screenShot,
			ExtentTest extendReport, boolean... shouldForceRandomNameCreation) throws Exception {
		try {

			boolean forceRandomValueFlag = shouldForceRandomNameCreation.length > 0 ? shouldForceRandomNameCreation[0]
					: false;
			...
			if (!email.contains("@"))
				email = testData.get("Email") + DateTimeUtility.getCurrentDateAndTime() + "SIAAS@ectest.com";
	...
	public void confirmCreateCustomer(boolean screenShot, ExtentTest extentedReport) throws Exception {
		WaitUtils.waitForSpinner(driver);
		try {
	...
	public void ValidateNewIPButon_cancelBut(ExtentTest extentReport, boolean Screenshot) throws Exception {
		WaitUtils.waitForelementToBeClickable(driver, addInterestcreateAddInterest,
				"CreateAddinterest button is not visible");
		try {
			...
			if (Ele_cnlBut.size() == 1)
				Log.message("Cancel button not found beside Crete New InterestedParty button", extentReport);
			else
				Log.fail("Cancel button found beside Crete New InterestedParty button. Investigation needed!!",
						extentReport);
	...
	public void IntParty_butsave(ExtentTest extentReport, boolean Screenshot) throws Exception {
		...
		try {
			...
			if (!WaitUtils.waitForElement(driver, but_IntPartysave, 3))
				Log.message("Interested party window closed successfully on clicking save button", extentReport);
		} catch (Exception e) {
	...
	public void Validate_errMsg_whenNoDateSet(ExtentTest extentReport, boolean Screenshot) throws Exception {
		...
		if (txt_errMsg_noDate.getText().equalsIgnoreCase("Please enter the To date"))
			...
			Log.fail("Failed to throw error message when to date not set on interested party window", extentReport);
	 ...
	 *            :boolean
	 */
	public void validate_corpContact_IntpartyFields(ExtentTest extentReport, boolean Screenshot) throws Exception {
	 ...
	 *            :hashmap
	 */
	public void search_lName_coporateIP(HashMap<?, ?> testData, ExtentTest extentReport, boolean Screenshot)
			throws Exception {
		WaitUtils.waitForSpinner(driver);
	...
	public void createCorporateContact(HashMap<?, ?> testdata, ExtentTest extentReport, boolean Screenshot)
			throws Exception {
		...
		try {
			...
			(new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
					.ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
					.withMessage("Unable to Switch to Windows")).until(ExpectedConditions.visibilityOf(txtTradeName));
	...
	public void enterBTBiz(String BTBiz) throws Exception {
		try {
			(new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
					.ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
					.withMessage("Unable to find BTBiz text box")).until(ExpectedConditions.visibilityOf(txtBTBiz));
			txtBTBiz.clear();
	...
	public void enterBTHome(String BTHome) throws Exception {
		try {
			(new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
					.ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
					.withMessage("Unable to find BTHome text box")).until(ExpectedConditions.visibilityOf(txtBTHome));
			txtBTHome.clear();
	...
	public void enterBTMob(String BTMob) throws Exception {
		try {
			(new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
					.ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
					.withMessage("Unable to find BTMob text box")).until(ExpectedConditions.visibilityOf(txtBTMob));
			txtBTMob.clear();
	...
	public void enterBEEmail(String BEEmail) throws Exception {
		try {
			(new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
					.ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
					.withMessage("Unable to find BEEmail text box")).until(ExpectedConditions.visibilityOf(txtBEEmail));
			txtBEEmail.clear();
		...
		try {
			(new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
					...
					.withMessage("Unable to find policy number text box"))
							.until(ExpectedConditions.invisibilityOfElementLocated(
									By.cssSelector("div.spinning-on-load-bg-table-active")));
			selectRadioButton("fieldset#FS_QUE_05DBD1E701916C229357567>div.radio", "Correspondence by email");
			Log.event("Selected marketing preferences");
		} catch (Exception e) {
			throw new Exception("Policy Number field is not displayed" + e);
		}
	...
	public void TakePayment(ExtentTest extentReport) throws Exception {
		try {
			WaitUtils.waitForelementToBeClickable(driver, btnTakePayment, "unable to click take payment button");
	 ...
	 *            :String
	 */
	public void selectJointPolicyHolderContactType(String ContactType, ExtentTest extendReport) throws Exception {
		try {
	 ...
	 * @param extendReport
	 * @throws Exception
	 * @param JointPolicy_lastname
	 *            :String
	 */

	public void enterJointPolicy_LastName(String JointPolicy_lastname, ExtentTest extendReport) throws Exception {
		try {
	 ...
	 * @param extendReport
	 * @throws Exception
	 * @param JointPolicy_firstname
	 *            :String
	 */

	public void enterJointPolicy_FirstName(String JointPolicy_firstname, ExtentTest extendReport) throws Exception {
		try {
	 ...
	 * @param extendReport
	 * @throws Exception
	 * @param JointPolicy_dateOfBirth
	 *            :String
	 */
	public void enterJointPolicy_DateOfBirth(String JointPolicy_dateOfBirth, ExtentTest extendReport) throws Exception {
		try {
	 ...
	 *            :String
	 */
	public void enterJointPolicy_PostCode(String JointPolicy_postcode, ExtentTest extendReport) throws Exception {
		try {
	 ...
	 * 
	 */
	public void searchJointPolicyHolder(HashMap<String, String> testdata, ExtentTest extendReport) throws Exception {
		try {
	 ...
	 * 
	 */
	public void addJointPolicyHolder(HashMap<String, String> testdata, ExtentTest extendReport) throws Exception {
		try {
	...
	public boolean verifyBinIconHeader(ExtentTest extendReport) throws Exception {
		try {
			...
			throw new Exception("Error while veriying the Header where bin icon is present in policy holder table" + e);
		}
	 ...
	 * @param
	 */
	public boolean verifyMainContact(String NameToVerify, boolean screenShot, ExtentTest extentedReport)
			throws Exception {
		...
		try {
			if (WaitUtils.waitForElement(driver, tablePolicyholder)) {
				...
				if (displayedMainContactName.contains(NameToVerify) && lstPolicyHeaderRows.get(0)
					...
					Log.message(NameToVerify + " : Name is displayed as main contact", driver, extentedReport, true);
					Log.message("Main checkbox of Name ( " + NameToVerify + ") is selected in policy header table",
	 ...
	 * @param screenShot
	 * @param NameToVerify
	 *            - PolicyHolder name to verify its availability
	 */
	public boolean verifyPolicyHolderContactName(String NameToVerify, boolean screenShot, ExtentTest extentedReport)
			throws Exception {
		try {
	 ...
	 * 
	 */
	public boolean verifyBinIcon(String NameToVerify, boolean screenShot, ExtentTest extentedReport) throws Exception {
		...
		try {
			...
			for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
				...
				String displayedContactName = row.findElement((By.cssSelector(cssContactName + (loopcount + 1))))
						.getText();
	 ...
	 * 
	 */
	public boolean verifyMaincheckbox(String NameToVerify, boolean screenShot, ExtentTest extentedReport)
			throws Exception {
		...
		try {
			...
			for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
				...
				if (displayedContactName.contains(NameToVerify)) {
					...
					WebElement checkboxMain = row.findElement((By.cssSelector(cssCheckBox + (loopcount + 1))));
	 ...
	 * @throws Exception
	 * @param NameToclick
	 *            - PolicyHolder name whose bin icon is to b clicked
	 */
	public void clickBinIcon(String NameToclick, boolean screenShot, ExtentTest extentedReport) throws Exception {
	 ...
	 * 
	 */
	public void clickNoToRemovePolicy(String NameToclick, boolean screenShot, ExtentTest extentedReport)
			throws Exception {
	 ...
	 * 
	 */
	public void clickMainCheckbox(String NameToclick, boolean screenShot, ExtentTest extentedReport) throws Exception {
			...
			for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
				...
				if (displayedContactName.contains(NameToclick)) {
					...
					if (!checkboxMain.isSelected()) {
						...
						Log.message("Main Checkbox is already clicked for contact name - " + NameToclick, driver,
								extentedReport, screenShot);
						break;
					}
				}
	 ...
	 *            - PolicyHolder name whose bin icon is to b clicked
	 */
	public void switchMainPolicyholder(boolean toSwitch, boolean screenShot, ExtentTest extentedReport)
			throws Exception {
		...
		try {
			if (toSwitch) {
				if (WaitUtils.waitForElement(driver, btnYesToChangeMainCheckbox)) {
					...
					Log.message("Yes button is clicked to switch the main policy holder", driver, extentedReport,
							screenShot);
				} else {
					throw new Exception("Yes button to switch the main policy holder is not available to click");
				}
			} else {
				if (WaitUtils.waitForElement(driver, btnNoToChangeMainCheckbox)) {
					btnNoToChangeMainCheckbox.click();
					Log.message("NO button is clicked to not switch the main policy holder", driver, extentedReport,
							screenShot);
				} else {
					throw new Exception("No button to not switch the main policy holder is not available to click");
	 ...
	 * 
	 */
	public boolean verifyJointPolicySearchResult(String nameToVerify, String addressToVerify, String dob,
			...
			for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
				...
				if (displayedName.contains(nameToVerify)) {
					...
					String displayedAddress = lstJointPolicySearchResult.get(loopcount)
							.findElement((By.cssSelector(cssJointPolicyAddress + (loopcount + 1)))).getText().trim()
							.replaceAll("\\s+", "");

					if (displayedAddress.contains(addressToVerify)) {
						Log.message(addressToVerify + " - Address is available in joint policy search result", driver,
								extentedReport);
	 ...
	 * 
	 */
	public boolean verifyJointPolicySelectOption(String nameToVerify, boolean screenShot, ExtentTest extentedReport)
			throws Exception {
		...
		try {
			...
			throw new Exception("Error while verifying the select option of joint policy search result" + e);
		}
	 ...
	 * 
	 */
	public void clickCreateNewJointPolicyHolder(ExtentTest extentedReport, boolean takeScreenShot) throws Exception {
	...
	public CardDetailsPage selectVisacard(ExtentTest extentedReport) throws Exception {
		...
		(new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS)
				.ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
				.withMessage("Spinner is active"))
						.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("div.loading-image")));
	 ...
	 * 
	 */
	public void clickViewButton(String NameToclick, boolean screenShot, ExtentTest extentedReport) throws Exception {
	...
	public boolean verifyJointPolicyDetail(HashMap<String, String> testdata, boolean screenShot,
		...
		try {
			...
			Thread.sleep(3000);
			WaitUtils.waitForelementToBeClickable(driver, cn_firstName, "Unable to locate the first name textbox");

			if (GenericUtils.verifyWebElementTextContains(selecttitle, title)) {
				Log.message(title + " - Given title is displayed in the title Textbox of joint policyholder", driver,
						extentedReport, screenShot);
			} else {
				ValueMatch = false;
			}
			...
			if (verifyFirstNameTxtBoxValue(firstName)) {
				Log.message(firstName + " - Given name is displayed in the first name Textbox of joint policyholder",
			...
			if (verifyLastNameTxtBoxValue(lastName)) {
				Log.message(lastName + " - Given name is displayed in the last name Textbox of joint policyholder",
						driver, extentedReport);
			} else {
				ValueMatch = false;
			}
			...
			if (verifyDOBTxtBoxValue(dob)) {
				Log.message(dob + " - Given DOB is displayed in the dob Textbox of joint policyholder", driver,
						extentedReport);
			} else {
				ValueMatch = false;
			}
			...
			if (cn_Email.getAttribute("value").contains(emailID)) {
				Log.message(emailID + " - Given emailID is displayed in the emailID Textbox of joint policyholder",
						driver, extentedReport);
			} else {
				ValueMatch = false;
			}
			...
			if (verifyPostCodeTxtBoxValue(postCode)) {
				Log.message(postCode + " - Given Postcode is displayed in the Postcode textbox of joint policyholder",
						driver, extentedReport);
			} else {
				ValueMatch = false;
			}
	...
	public boolean verifyPostCodeTxtBoxValue(String valueToVerify) throws Exception {
		try {
			return cn_postCode.getAttribute("value").trim().replaceAll("\\s+", "").contains(valueToVerify);
	...
	public boolean verify_ContactSurName_Alphabeticalorder(ExtentTest extentedReport) throws Exception {
		try {
	...
	public boolean verifyMandatoryTandCMessage(String textToVerify, ExtentTest extentedReport, boolean screenShot)
			throws Exception {
		try {
	...
	public boolean verifyMandatoryTandCEditable(ExtentTest extentedReport, boolean screenShot) throws Exception {
		try {
	...
	/**
	 * Description : To verify whether the star icon is available for newly
	 * added terms and condition is added under terms & condition section
	 * 
	 * Return : boolean
	 * 
	 * @param extentedReport
	 * 
	 * @param policyToVerify
	 *            - Policy name
	 * @param Screenshot
	 * 
	 * @throws Exception
	 *             : Custom Exception Message
	 */
	public boolean isStarIconDispalyed(String policyToVerify, ExtentTest extentedReport, boolean Screenshot)
			throws Exception {
		try {
			...
			for (int i = 0; i < addedPolicyRow.size(); i++) {
				String displayedPolicyName = addedPolicyRow.get(i)
						.findElement(By.cssSelector("[id*='C1__QUE_304899FEFEF1DDEB353990_R1_" + (i + 1) + "']"))
						.getText();

				if (displayedPolicyName.equals(policyToVerify)) {

					Log.message(policyToVerify + " - T&C is available under terms & condition section", driver,
							extentedReport);
	 ...
	 * @param extentedReport
	 * @param Screenshot
	 * @param policyToSelect
	 *            - Policy name
	 * 
	 * @throws Exception
	 *             : Custom Exception Message
	 */
	public void selectTandCPolicy(String policyToSelect, ExtentTest extentedReport, boolean Screenshot)
			throws Exception {
		try {
			...
			for (int i = 0; i < PolicyOptions.size(); i++) {
				...
				if (displayedPolicyName.equals(policyToSelect)) {
					...
					WebElement rowToselect = PolicyOptions.get(i)
							.findElement(By.cssSelector("[id*='C1__QUE_3A056143913CF4954126760_R" + (i + 1) + "']"));
			...
			WaitUtils.waitForinvisiblityofElement(driver, 240, cssComponentDropDown, "Policy window did not close");
	 ...
	 *             : Custom Exception Message
	 */
	public boolean verifyTandCPolicyadded(String policyToVerify, ExtentTest extentedReport, boolean Screenshot)
			throws Exception {
		try {
			WaitUtils.waitForElement(driver, MandatoryTandC);
	...
	/**
	 * Description : To verify whether the terms and condition is editable under
	 * terms & condition section
	 * 
	 * Return : boolean
	 * 
	 ...
	 *             : Custom Exception Message
	 */
	public boolean verifyTandC_Editable(String policyToClick, ExtentTest extentedReport, boolean Screenshot,
			String randomValue) throws Exception {
		try {
			...
			for (int i = 0; i < PolicyOptions.size(); i++) {
				...
				if (displayedPolicyName.equals(policyToClick)) {
					rowToClick.click();
					Log.message(policyToClick + " - added T&C is clicked under terms&condition", driver, extentedReport,
							Screenshot);
					isClicked = true;
					rowValue = i;
					break;
			...
			if (WaitUtils.waitForElement(driver, rowToClick
					.findElement(By.cssSelector("[id*='C1__BUT_304899FEFEF1DDEB941705_R1_" + (rowValue + 1) + "']")))) {
				rowToClick
						.findElement(By.cssSelector("[id*='C1__BUT_304899FEFEF1DDEB941705_R1_" + (rowValue + 1) + "']"))
						.click();
			...
			if (WaitUtils.waitForElement(driver, rowToClick.findElement(By.cssSelector(cssTandCTextArea)))) {
				...
				WaitUtils.waitForElement(driver, rowToClick.findElement(
						By.cssSelector("[id*='C2__C1__p4_QUE_A048EC24ED762AD77362602_R1_" + (rowValue + 1) + "']")));
				WebElement newtxtAreaTandC = rowToClick.findElement(
						By.cssSelector("[id*='C2__C1__p4_QUE_A048EC24ED762AD77362602_R1_" + (rowValue + 1) + "']"));

				String EditedText = newtxtAreaTandC.getText();
				if (EditedText.contains(randomValue)) {
					Log.message(policyToClick + " - Selected T&C contains edited string", driver, extentedReport,
							Screenshot);
					isEditable = true;
				}
	...
	/**
	 * Description : To verify the button for terms and condition is added under
	 * terms & condition section
	 * 
	 * Return : boolean
	 * 
	 ...
	 *             : Custom Exception Message
	 */
	public boolean verifyButtonForTandC(String policyToClick, ExtentTest extentedReport, boolean Screenshot)
			throws Exception {
		try {
			WaitUtils.waitForElement(driver, MandatoryTandC);
			...
			if (WaitUtils.waitForElement(driver, rowToClick.findElement(By.cssSelector(cssEditButton)))) {
				...
				Log.message("Edit button is available for the added T&C", driver, extentedReport, Screenshot);
			}

			if (WaitUtils.waitForElement(driver, rowToClick.findElement(By.cssSelector(cssDeSelectButton)))) {
				isButtonAvailable = true;
				Log.message("De-Select button is available for the added T&C", driver, extentedReport, Screenshot);
			}
	 ...
	 * 
	 */
	public void clickChangePayorButton(ExtentTest extentedReport, boolean Screenshot) throws Exception {
		try {
			GenericUtils.scrollIntoView(driver, btnChangePayor);
			WaitUtils.waitForelementToBeClickable(driver, btnChangePayor, "Change Payor button not enabled");
	 ...
	 * 
	 */
	public void clickCloseChangePayorModal(ExtentTest extentedReport, boolean Screenshot) throws Exception {
		try {
	 ...
	 * 
	 */
	public void clickCancelChangePayorModal(ExtentTest extentedReport, boolean Screenshot) throws Exception {
		try {
	 ...
	 * 
	 */
	public void clickPayorSearchButton(ExtentTest extentedReport, boolean Screenshot) throws Exception {
		try {
	 ...
	 * 
	 */
	public String selectChangePayor(String lastName, String firstName, String postcode, ExtentTest extentedReport,
			boolean Screenshot) throws Exception {
		String[] name = null;
	 ...
	 * 
	 */
	public boolean verifyPayorFieldsErrorMsg(String type, String lastName, String firstName, String postcode,
			String errorMsg, ExtentTest extentedReport) throws Exception {
		boolean status = false;
		if (type.equalsIgnoreCase("All Fields")) {
			clickPayorSearchButton(extentedReport, false);
			if (GenericUtils.verifyWebElementTextEquals(errorMsgPayorMandatoryFields, ERROR_MSG_PAYOR_ALLFIELDS))
				status = true;
			Thread.sleep(2000);
			...
			clickPayorSearchButton(extentedReport, false);
			if (GenericUtils.verifyWebElementTextEquals(errorMsgPayorMandatoryFields, ERROR_MSG_PAYOR_POSTCODE_OR_DOB))
				status = true;
			Thread.sleep(2000);
			...
			clickPayorSearchButton(extentedReport, false);
			if (GenericUtils.verifyWebElementTextEquals(errorMsgPayorMandatoryFields, ERROR_MSG_PAYOR_LASTNAME))
				status = true;
			Thread.sleep(2000);
		}
		return status;
	...
	/**
	 * Description : To verify edit and save terms&condition under terms &
	 * condition section
	 * 
	 * @param extentedReport
	 * @param Screenshot
	 ...
	 *             : Custom Exception Message
	 */
	public boolean verifyTandC_Edited(String policyToEdit, String randomValue, ExtentTest extentedReport,
			boolean Screenshot) throws Exception {
		try {
			boolean isedited = false;
			boolean isClicked = false;
			...
			if (WaitUtils.waitForElement(driver, rowToClick.findElement(By.cssSelector(cssTandCTextArea)))) {
				...
				Log.message(policyToEdit + " - T&C is clicked again after values are edited", driver, extentedReport);

				String cssNewTxtArea = "[id*='C2__C1__QUE_A048EC24ED762AD77362602_R1_" + (rowValue + 1) + "']";
				txtAreaTandC = rowToClick.findElement(By.cssSelector(cssNewTxtArea));

				String EditedText = txtAreaTandC.getText();
				if (EditedText.contains(randomValue)) {
					isedited = true;
					Log.message("Edited strings are saved in T&C after clicking save button", driver, extentedReport,
							Screenshot);
				}
	...
	public void tickSpokenDirectlyNewPayorCheckbox(ExtentTest extentedReport) throws Exception {
		try {
			...
			throw new Exception("Exception in checking the 'I have spoken to New Payor...' checkbox." + e);
		}
	}

	/**
	 * Selects the 'Customer agrees...Direct Debit Guarantee' checkbox if it is
	...
	public void tickCustomerAgreesCheckbox(ExtentTest extentedReport) throws Exception {
		try {
			...
			if (!chkCustAgree.isSelected()) {
				chkCustAgree.click();
				WaitUtils.waitForSpinner(driver);
				Log.message("Checked the 'Customer agrees...Direct Debit Guarantee' checkbox", extentedReport);
			} else {
				Log.message("The 'Customer agrees...Direct Debit Guarantee' checkbox is already checked",
						extentedReport);
			}
		} catch (Exception e) {
			throw new Exception("Exception in checking the 'Customer agrees...Direct Debit Guarantee' checkbox." + e);
		}
	}
	 ...
	 *             : Custom Exception Message
	 */
	public void clickCancelBtnOfTandC(String policyToClick, ExtentTest extentedReport, boolean Screenshot)
			throws Exception {
		try {
			WaitUtils.waitForElement(driver, MandatoryTandC);
			...
			if (WaitUtils.waitForElement(driver, rowToClick.findElement(By.cssSelector(cssCancelButton)))) {
				rowToClick.findElement(By.cssSelector(cssCancelButton)).click();
				WaitUtils.waitForElement(driver, mdlConfirmationWnd);
				Log.message("Cancel button is clicked for the T&C - " + policyToClick, driver, extentedReport,
						Screenshot);
			} else {
				rowToClick.click();
				rowToClick.findElement(By.cssSelector(cssCancelButton)).click();
	...
	/**
	 * Description : To click NO button of confirmation dialog of
	 * Terms&condition
	 * 
	 * @param extentedReport
	 * @param Screenshot
	 ...
	 *             : Custom Exception Message
	 */
	public void clickBtnOfTandCConfirmationWnd(String buttonName, ExtentTest extentedReport, boolean Screenshot)
			throws Exception {
		try {
			WaitUtils.waitForElement(driver, mdlConfirmationWnd);
			if (buttonName.equals("yes")) {
				btnYesTandC.click();
				Log.message("Yes button is clicked to save the edit of T&C", driver, extentedReport, Screenshot);
			} else {
				btnNoTandC.click();
				Log.message("No button is clicked to not save the edit of T&C", driver, extentedReport, Screenshot);
			}
	 ...
	 * 
	 */
	public void enterChangePayorDetail(String lastName, String firstName, String postcode, ExtentTest extentedReport,
			boolean Screenshot) throws Exception {
		try {
			Thread.sleep(1000);
			WaitUtils.waitForelementToBeClickable(driver, fldPayorLastName, "Payor last name is not clickable");
			fldPayorLastName.clear();
			fldPayorLastName.sendKeys(lastName);
			Log.message("Entered Payor Last Name : " + lastName, driver, extentedReport);
	 ...
	 * 
	 */
	public boolean verifyTabTitles(String pagename, boolean Screenshot, ExtentTest extentReport) throws Exception {
		boolean status = false;
		WaitUtils.waitForElementPresent(driver, datacapturetitle, "Element is displayed on data capture page");
		...
		case "acceptance":
			WaitUtils.waitForElementPresent(driver, accptancetitle, "Element is displayed on data capture page");
	 ...
	 *             : Custom Exception Message
	 */
	public boolean rnlIncpt(String incep, boolean Screenshot, ExtentTest extentReport) throws Exception {
		boolean status = true;
		try {
	...
	public void changePayorDetails(String lastName, String firstName, String postcode, ExtentTest extentedReport)
			throws Exception {
		try {
			fldPayorLastName.sendKeys(lastName);
			Log.message("Entered Payor Last Name : " + lastName, driver, extentedReport);
	...
	public boolean selectPayment(String paymentPlan, HashMap<String, String> testData, boolean Screenshot,
			ExtentTest extentedReport) throws Exception {
		boolean status = false;
		try {
			if (paymentPlan.equals("Monthly")) {
				status = true;
				clickAddAccountDetails(extentedReport);
				checkBankAccount(testData.get("Account Number").toString(), testData.get("Sort Code").toString(),
						extentedReport);
	...
	public CustDashboardPage confirmPaymentRnl(String paymentplan, ExtentTest extentedReport) throws Exception {
		CustDashboardPage objCustDashboardPage = null;
		try {
	 ...
	 * 
	 */
	public boolean verifyChangePayorSearchResult(String nameToVerify, boolean screenShot, ExtentTest extentedReport)
			throws Exception {
			...
			for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
				...
				if (displayedName.contains(nameToVerify)) {
					...
					if (WaitUtils.waitForElement(driver, selectOption)) {
						boolPresent = true;
						selectOption.click();
						Log.message(nameToVerify + " - Given name is selected for change payor", driver, extentedReport,
								screenShot);
						break;
					}
	...
	public void searchAndSelectChangePayor(String lastName, String firstName, String postcode,
		...
		try {
			...
			WaitUtils.waitForElementPresent(driver, btnPayorConfirm, "Confirm New Payor button is not found");
	 ...
	 * 
	 */
	public String enterChangePayorDetails(String lastName, String firstName, String postcode, ExtentTest extentedReport,
			boolean Screenshot) throws Exception {
		String[] name = null;
		String payorName = null;
