...
public class UXP_EC_1599 extends BaseTest {
	...
	@Test(description = "Check for interested party pane - Validate the message \"No interested party have been added\" - Click interested party - Check for Add interesparty and search results -Check the fields of panes - Add existing Int party - Check the delete icon on newquote page and select Yes", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Check for interested party pane - Validate the message \"No interested party have been added\" - Click interested party - Check for Add interesparty and search results -Check the fields of panes - Add existing Int party - Check the delete icon on newquote page and select No", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Check for interested party pane -Check the delete icon on newquote page and verify that page gets to new quote when clicking close(X) button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify that user able to add personal contact as interested party",dataProviderClass = DataProviderUtils.class, dataProvider ="ssBVTDataProvider")
	public void TC_97_104(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				custdashboardPage = searchPage.clickSearchedContactPolicy("policy", policyDetails.get("PolicyNo"), "",
						true, extentedReport);
	...
	@Test(description = "Add Existing Personal contact as interested party - validate the warning message, fields on Interesdparty window", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Validate Search fields when personal contact type changed to corporate contact on search pane of interested party window", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Search NB policy and perform MTA with all covers added and Check that the 'Policyholders' column displays the personal contact name as per the below format while performing MTA '<Title, First Name, Last Name>' on getquote page", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_58(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(getquotepage.verifyPolicyHolderSection(title + " " + testData.get("First Name") + " " + testData.get("Last Name"), extentedReport),
						"Policy holder section displayed the customer name",
						"Policy holder section failed to display customer name in getquotepage");

			} else {
				Log.fail("NB Policy has failed to Create in Accepted status, unable to procced with MTA", driver,
						extentedReport, true);
	...
	@Test(description = "check that  additional covers that are available to add to a policy are displayed under the 'Add Cover' section", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_F56(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("txt_addCover","txt_AddCoverLE","txt_AddCoverHE"), newquotepage),
					"Verified Add cover section ", "Failed to verify add cover section in new quote page", driver, extentedReport, true);
			
			
			//Log.softAssertThat(newquotepage.verify_AddCoverSection(true, extentedReport), "Verified Add cover section ",
	...
	@Test(description = "check that  ‘No interested parties have been added’ message is displayed in the 'Interested Parties' section if a policy does not have an interested party", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "check that  'Add Interested Party' modal is displayed on clicking 'Add Interested Party' button on the cover page", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_F66(String browser) throws Exception {
		...
		try {
			...
			newquotepage.clickAddParties(extentedReport, true);
			newquotepage.selectContactType(addInterestContactType, extentedReport);
			Log.pass("Add Interested Party modal is displayed on clicking 'Add Interested Party' button on the cover page",
					driver, extentedReport, true);
			Log.testCaseResult(extentedReport);
	...
	@Test(description = "Check that the search button is active only after selecting the value from 'Contact Type' drop down in MTA policy", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				if (BoolVal != false) {
					...
					Log.softAssertThat(!getquotepage.verify_searchButton(extentedReport),
							"Search button on interested party modal was disabled when no data entered as expected", "Search button was enabled when no data entered in intersted party modal, which is not expected", driver, extentedReport, true);
					
					getquotepage.selectContactType(testData.get("AddInterestContactType"), extentedReport);
					
					Log.softAssertThat(getquotepage.verify_searchButton(extentedReport),
							"Search button is enabled when contact type selected", "Search button was disabled even after selecting contact type", driver, extentedReport, true);
	...
	@Test(description = "Check that the user is able to search with 'LastName' and 'FirstName' when selecting 'Personal Contact' as 'Contact Type' drop down for MTA policy", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
...
//				}
	...
	@Test(description = "Check that the existing 'Interested Parties' are displayed under 'Search results' pane when filling the required details and click on 'Search' button in the 'Add Interested Party' modal", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_F76(String browser) throws Exception {
		...
		try {
			...
			newquotepage.clickselect(extentedReport, true);
			Log.pass("Interested party search results are displayed, user able to select the contact as interested party", driver, extentedReport, true);
	...
	@Test(description = "Check that 'Remove Interested Party' modal is displayed when clicking on 'bin' icon in the cover page", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_F78(String browser) throws Exception {
		...
		try {
			...
			newquotepage.checkremoveDescription();
			Log.pass("Remove Interested Party' modal is displayed when clicking on 'bin' icon in the cover page", driver, extentedReport, true);
	...
	public void TC_F81(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(!newquotepage.verify_IntPartyName(testData.get("Title") + " " + testData.get("First Name") + " " + testData.get("Last Name"),extentedReport),
					"Intersted party has been removed after clicking yes button in remove modal",
					"Interested party was not removed after clicking yes button in remove modal", driver, extentedReport, true);
	...
	@Test(description = "Check that  clicking on 'No' option in Remove Interested Party' modal does NOT remove the Interested Party", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Check that  'Remove Interested Party' modal is closed when clicking on 'X' icon", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_F83(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(!newquotepage.uielement.verifyPageElements(Arrays.asList("closebtn"), newquotepage),
					"Remove interested party modal was closed when clicked on X button",
					"Remove interested party modal was not closed when clicked on X button", driver, extentedReport, true);
	...
	@Test(description = "Add corporate contact as interested party and verify the name interested party section of new quote page", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_F73(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verify_IntPartyName(testData.get("Trade Name"), extentedReport), "Selected corporate contact interested party was displayed in newquote page as expected", "Selected corporate contact interested party was not displayed in newquote page", driver, extentedReport, true);
	...
	@Test(description = "Check that 'Personal' tab is active when 'create new interested party' button is selected while keeping 'personal contact' as 'Contact Type' dropdown - MTA", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				// Loop to add items to the existing ins cover
				 for (int i = 0; i < coversToAdd.length; i++) {
					...
					Log.softAssertThat(getquotepage.verify_defaultContactTab("Personal",extentedReport,true), "Personal contact tab was selected by default",
							"Personal contact tab was not selected as default tab, when interested party contact type set to personal", driver, extentedReport, true);
	...
	@Test(description = "Check that  'Corporate' tab is active when 'create new interested party' button is selected while keeping 'Corporate contact' as 'Contact Type' dropdown - MTA", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				// Loop to add items to the existing ins cover
				 for (int i = 0; i < coversToAdd.length; i++) {
					...
					Log.softAssertThat(getquotepage.verify_defaultContactTab("Corporate",extentedReport,true), "Corporate contact tab was set to default tab",
							"Corporate contact tab was not selected as default tab, when interested party contact type set to corporate", driver, extentedReport, true);
	...
	@Test(description = "Check that user is able to toggle between 'Personal' and 'Corporate' tabs in the Create New Interested Party moda - MTA", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				// Loop to add items to the existing ins cover
				 for (int i = 0; i < coversToAdd.length; i++) {
					...
					Log.softAssertThat(getquotepage.verify_defaultContactTab("Corporate",extentedReport,true), "User able to switch between personal and corporate contact tabs",
							"User not able to switch between personal and corporate contact tabs", driver, extentedReport, true);
