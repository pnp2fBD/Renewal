...
public class UXP_EC_1754 extends BaseTest {
	...
	@Test(description = "Verify Change Password screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify User able to change Password from change Password screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_460(String browser) throws Exception {
		...
		try {
			...
			homePage.clickChangePassword(extentedReport);
			Log.softAssertThat(homePage.uielement.verifyPageElements(Arrays.asList("fldChPwdReEnterPwd"), homePage),
					"Change Password page is loaded", "Change Password page is not loaded", driver, extentedReport,
					true);
	...
	@Test(description = "Verify My Dashboard screen list of options after successful logging into Engagement Center application", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_461(String browser) throws Exception {
		...
		try {
			...
			// Login to the application
			HomePage homePage = loginPage.loginToSSP(userName, password, false, extentedReport);
			Log.softAssertThat(homePage.verifyHomePage(), "Successfully logged into SIAAS Home Page", "Login failed",
					driver, extentedReport, true);

			Log.softAssertThat(
					homePage.uielement.verifyPageElements(Arrays.asList("lnkTakeCall", "lnkMakeCall", "lnkAdminTask"),
							homePage),
	...
	@Test(description = "Verify User redirect to Search after click in the Take Call/Make Call/Admin Task/Direct Contact ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify List of search option available in the Search screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_463(String browser) throws Exception {
		...
		try {
			...
			homePage.clickMyBrands(brandName, extentedReport);
			SearchPage searchPage = new SearchPage(driver, extentedReport).get();
			Log.softAssertThat(searchPage.uielement.verifyPageElements(
					Arrays.asList("btnSearch", "btnClearSearch", "btnCreateCustomer", "btnComplete"), searchPage),
	...
	@Test(description = "Verify User able to search Contact  with options (Policy Number, External Quote Number, External Client Reference) which has available in Quick Search section", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify User not able to retrieve any information from non existence Policy ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify User able to search Contact with options (LastName,FirstName) which has available in Advanced Search section", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify error message while searching user with only first name", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_467(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(searchPage.verifyLnameError(textToVerify), "Message appeared as : " + textToVerify,
					"Error message not displayed", driver, extentedReport, true);
			searchPage.clickComplete(extentedReport);
	...
	@Test(enabled = false, description = "Verify error message while searching user with only last name", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(enabled = false, description = "Verify User able to search Contact with options (Business/Trade Name/Postcode/Date of Birth) which has available in Advanced Search section", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_469(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					searchPage.uielement.verifyPageElements(Arrays.asList("tablePolicyItems", "tab_headerContact",
							"tab_headerDateOfBirth", "tab_headerAddress"), searchPage),
					"The user searched is displayed with 'Contact', 'Address', 'DateOfBirth' details and 'Policy' in table format",
					"Searching policy number is not available", driver, extentedReport, true);
	...
	// is not yet implemented in 'Insurer' (error msg). (Based on the discussion
	// with Venkatesh N. on May 24, 2017)
	@Test(enabled = false, description = "Verify User not able to search contact with only Business/Trade Name", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify User not able to search contact with only Postcode", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify User not able to search contact with only Date Of Birth", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	// is not yet implemented in 'Insurer' (error msg). (Based on the discussion
	// with Venkatesh N. on May 24, 2017)
	@Test(enabled = false, description = "Verify System will throw warning message for  contact search which does not have quote/Policy", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_473(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(searchPage.verifyErPolicyNotFound(textToVerify), "Message appeared as : " + textToVerify,
					"Error message not displayed", driver, extentedReport, true);
	...
	@Test(description = "Verify Clear Search button behavior in the My Dashboard screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_474(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(GenericUtils.verifyTextEquals(strFnameValue, ""), "The Firstname field become empty",
					"The first name field is not empty", driver, extentedReport, true);
			Log.softAssertThat(GenericUtils.verifyTextEquals(strLnameValue, ""), "The Lastname field become empty",
					"The last name field is not empty", driver, extentedReport, true);
	...
	@Test(description = "Verify Complete button behavior in the My Dashboard screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Verify that the version details for Pure is displayed in the 'About' pop up", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_477(String browser) throws Exception {
		...
		try {
			...
			Log.message("Actual Language: '" + strLanguage + "'; Expected Language: '" + strLangToVerify + "'",
					extentedReport);
			String strVersion = homePage.getAppVersionInAbtPopUp();
			Log.message("Actual Version: '" + strVersion + "'; Expected Version: '" + strVersionToVerify + "'",
					extentedReport);
			String strTitle = homePage.getAppTitleInAbtPopUp();
			Log.message("Actual Title: '" + strTitle + "'; Expected Title: '" + strTitleToVerify + "'", extentedReport);

			Log.softAssertThat(GenericUtils.verifyTextEquals(strVersion, strVersionToVerify),
					"The version is '" + strVersion + "' as expected", "The version is not correct : " + strVersion,
					driver, extentedReport, true);

			Log.softAssertThat(GenericUtils.verifyTextEquals(strTitle, strTitleToVerify),
					"The title is '" + strTitle + "' as expected", "The title is not correct : " + strTitle, driver,
					extentedReport, true);

			Log.softAssertThat(GenericUtils.verifyTextEquals(strLanguage, strLangToVerify),
					"The language is '" + strLanguage + "' as expected", "The language is not correct : " + strLanguage,
					driver, extentedReport, true);
	...
	@Test(description = "Verify that the Insurer User’s actual name is displayed in the Agent dashboard", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
