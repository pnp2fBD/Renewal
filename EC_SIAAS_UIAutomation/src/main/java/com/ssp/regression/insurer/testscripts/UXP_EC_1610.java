...
public class UXP_EC_1610 extends BaseTest {
	...
	@Test(description = "To check that the Terms and Conditions can be viewed from 'Manage Policy --> MTA' for an existing contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_271(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(homePage.verifyHomePage(), "Successfully logged into Home Page", "Login failed",
            ...
            CustDashboardPage custdashboardpage = searchPage
                         .confirmCreateCustomer(true, extentedReport);
            Log.softAssertThat(
                         custdashboardpage.uielement.verifyPageElements(
                                       Arrays.asList("lnkEditDetails"), custdashboardpage),
                         "Customer Dashboard page is verified",
                         "Customer Dashboard page is not verified", driver, extentedReport,
                         true);
            Log.softAssertThat(
                         custdashboardpage.verifyContactName(CustomerName, extentedReport, true),
                         "Verified Searched FirstName and LastName on Customer Dashboard",
                         "Not Verified Customer Details on Dashboard", driver,
                         extentedReport, true);

            // Create New Quote
            custdashboardpage.clickNewQuote(true, extentedReport);
            custdashboardpage.enterQuoteDetails(testData, true, extentedReport);
            NewQuotePage newquotepage = custdashboardpage.clickContinueQuote(
                         true, extentedReport);

            // Verify Quote
            Log.softAssertThat(
                         newquotepage.verifyNewQuotePage(true, extentedReport),
                         "Verified NewQuotePage ", "Not verified NewQuotePage",
                         driver, extentedReport, true);
...
//            newquotepage.verifyPaymentTrasaction(extentedReport);
            ...
            Log.softAssertThat(custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),"Customer Dashboard page is verified","Customer Dashboard page is not verified", driver, extentedReport,true);
            
                                 
            // check for policy status
            HashMap<String, String> policyDetails = custdashboardpage
                         .getPolicyURN(extentedReport);
            Log.softAssertThat((policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")),"NB Policy Created Successfully in accepted status","Failed - NB Policy Created in "+ policyDetails.get("Status").toString() + " status");
...
//			 custdashboardpage.clickComplete();
			...
			searchPage.enterPolicyNumber(policyDetails.get("policyNo"));
			createdPolicyNo = policyDetails.get("policyNo");
	...
	@Test(description = "To check that the Terms and Conditions can be viewed from New Quote for an existing contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_267(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyReadTermsAndCondition(extentedReport),
					"Verified Read Terms and Conditions", "Not able to verify Read Terms and Conditions", driver,
					extentedReport, true);*/
	...
	@Test(description = "To check that the Terms and Conditions can be edited from New Quote for an existing contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the Terms and Conditions can be viewed from New Quote for a New contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the Terms and Conditions can be edited from New Quote for a New contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the Terms and Conditions can be viewed from 'Manage Policy --> STA' for an existing contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the Terms and Conditions can be edited from \"Manage Policy --> MTA \" for an existing contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the Terms and Conditions can be edited from 'Manage Policy --> STA' for an existing contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_274(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyEditTermAndCondition(extentedReport),
					...
					"Terms and Conditions can not be edited from STA for an existing contact", driver, extentedReport,
					true);
	...
	@Test(description = "To check that the Terms and Conditions can be viewed from 'Manage Policy --> Invite Renewal' for an existing contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the Terms and Conditions can be edited from 'Manage Policy --> Invite Renewal' for an existing contact and check that the modified T&C is displayed in the customer dashboard", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_276(String browser) throws Exception {
		...
		try {
            ...
            Log.softAssertThat(newquotepage.verifyTandC_Edited(policyToSelect, randomValue, extentedReport, true),
			...
			Log.softAssertThat(custdashboardpage.verifyEditedValueExitsInTermAndCond(policyToSelect, randomValue, extentedReport, true),
	...
	@Test(description = "To check that the user is NOT able to edit the Terms and Conditions that are mandatory", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_278(String browser) throws Exception {
		...
		try {
            ...
            // Verify Quote
            Log.softAssertThat(newquotepage.verifyTandCPolicyadded(policyToSelect, extentedReport, false),
            		policyToSelect + " - T&C is added under terms & condition section", policyToSelect + " - T&C is not added under terms & condition section",
                         driver, extentedReport, true);
            
            Log.softAssertThat(newquotepage.verifyMandatoryTandCMessage(mandatoryMessage, extentedReport, false),
            		mandatoryMessage + " - is displayed under terms & condition section", mandatoryMessage + " - is not displayed under terms & condition section",
                         driver, extentedReport, true);
            
            //Click & verify mandatroy policy
            Log.softAssertThat(!newquotepage.verifyMandatoryTandCEditable(extentedReport, false),
            		"Mandatory Policy is not editable since edit button is not available", "Mandatory Policy is editable since edit button is available",
                         driver, extentedReport, true);
	...
	@Test(description = "To check that a Star icon is added against the new Coverage Name of one or more T&C", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
		...
		try {
            ...
            for (int i = 0; i < arrPolicy.length; i++) {
				...
				Log.softAssertThat(newquotepage.verifyTandCPolicyadded(arrPolicy[i], extentedReport, false),
						...
						arrPolicy[i] + " - T&C is not added under terms & condition section", driver, extentedReport,
						true);
				...
				if (i == 0) {
					...
					Log.softAssertThat(newquotepage.isStarIconDispalyed(arrPolicy[i], extentedReport, false),
							...
							"Star icon is not added against the new Coverage Name of one or more T&C", driver, extentedReport, true);
				}
            }
	...
	@Test(description = "To check that the policy wording is collapsed if click on Close button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_302(String browser) throws Exception {
		...
		try {
            ...
            Log.softAssertThat(custdashboardpage.verifyAddedTandC_Collapsed(policyToSelect, extentedReport, true), "The policy wording is collapsed after clicking the close button",
            		"The policy wording is not collapsed after clicking the close button", driver, extentedReport, true);
	...
	@Test(description = "To check that Editor controls consist of the following buttons 'Edit and De-select' depending on the type of T&C", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_308(String browser) throws Exception {
		...
		try {
            ...
            Log.softAssertThat(newquotepage.verifyButtonForTandC(policyToSelect, extentedReport, false),
            		policyToSelect + " - policy T&C that are not mandatory is having buttons Edit & De-select", 
            		policyToSelect + "  - policy T&C that are not mandatory is not having buttons Edit & De-select",
                         driver, extentedReport, true);
	...
	@Test(description = "To check that user is able to edit the text when click on 'Edit' button with correct skills profile", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_321(String browser) throws Exception {
		...
		try {
            ...
            Log.softAssertThat(newquotepage.verifyTandC_Editable(policyToSelect, extentedReport, true, "ABC"),
            		"User is able to edit the text when click on 'Edit' button with correct skills profile", 
            		"User is unable to edit the text when click on 'Edit' button with correct skills profile",
                         driver, extentedReport, true);
	...
	@Test(description = "To check that user is able to apply the edited terms and conditions when click on 'save' button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the user is able to add a T & C to a policy when click on 'Select' button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_331(String browser) throws Exception {
		...
		try {
            ...
            // Verify T&C is added
            Log.softAssertThat(newquotepage.verifyTandCPolicyadded(policyToSelect, extentedReport, false),
            		"User is able to add a T & C to a policy when click on 'Select' button", "User is unable to add a T & C to a policy when click on 'Select' button",
                         driver, extentedReport, true);
	...
	@Test(description = "To check that 'Any changes you have made to this Term & Condition will be lost if you do not Save.Do you wish to Save?' is prompted when 'Cancel' button is clicked", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_327(String browser) throws Exception {
		...
		try {
            ...
            Log.softAssertThat(newquotepage.verifyTandCPolicyadded(policyToSelect, extentedReport, false),
            		policyToSelect + " - T&C is added under terms & condition section", 
            		policyToSelect + " - T&C is not added under terms & condition section",
                    driver, extentedReport, true);
            ...
            Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("mdlConfirmationWnd"), newquotepage),
	...
	@Test(description = "To check that 'Any changes you have made to this Term & Condition will be lost if you do not Save. Do you wish to Save?' modal has 2 buttons 'Yes' and 'No'", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_328(String browser) throws Exception {
		...
		try {
            ...
            Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("btnYesTandC"), newquotepage),
                    "Yes button is available in the cofirmation dialog",
                    "Yes button is not available in the cofirmation dialog", 
                    driver, extentedReport,
                    true);
            
            Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("btnNoTandC"), newquotepage),
                    "No button is available in the cofirmation dialog",
                    "No button is not available in the cofirmation dialog", 
                    driver, extentedReport,
                    true);
	...
	@Test(description = "To check that selecting 'Yes' saves the edits made by the user on a particular T&C", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_329(String browser) throws Exception {
		...
		try {
            ...
            Log.softAssertThat(newquotepage.verifyTandC_Editable(policyToSelect, extentedReport, false, ValueToEdit),
            		policyToSelect + " - T&C is edited under terms & condition section", 
            		policyToSelect + " - T&C is not edited under terms & condition section",
                    driver, extentedReport, true);
            ...
            Log.softAssertThat(newquotepage.verifyTandC_Editable(policyToSelect, extentedReport, false, ValueToEdit),
            		policyToSelect + " - T&C contain the edited value - " + ValueToEdit + " - After clicking YES button", 
            		policyToSelect + " - T&C does not contain the edited value - " + ValueToEdit + " - After clicking YES button",
                    driver, extentedReport, true);
