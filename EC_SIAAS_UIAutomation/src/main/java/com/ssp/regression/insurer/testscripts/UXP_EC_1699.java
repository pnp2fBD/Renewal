		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
               ...
               //By default the Automatic Review, Renewal - Enabled and checked, Block Renewal - Unchecked(Validating that below)
				...
				Log.softAssertThat(!getquotepage.validateReviewRenewalFields("Block Renewal", "checked",extentedReport,
				...
				getquotepage.validateReviewRenewalFields("Automatic Review", "disabled",extentedReport,true);
				getquotepage.validateReviewRenewalFields("Automatic Renewal", "disabled",extentedReport,true);
				Log.softAssertThat(!getquotepage.validateReviewRenewalFields("Automatic Review", "checked",extentedReport,true) && getquotepage.validateReviewRenewalFields("Automatic Renewal", "checked",extentedReport,	true) , "Both Automatic Renewal and Automatic Review fields were unchecked as expected", "Both Automatic Renewal and Automatic Review fields were not unchecked", driver);
				//getquotepage.validateReviewRenewalFields("Automatic Renewal", "checked",extentedReport,	true);
				...
				getquotepage.verifyGetQuotePage(extentedReport);
				Log.pass("Get quote page loaded successfully", driver, extentedReport, true);
				Log.softAssertThat(!getquotepage.validateReviewRenewalFields("Automatic Review", "checked",extentedReport,true),"Automatic Review field displayed as unchecked which is expected", "Automatic Review field found to be checked,the unchecked flag during MTA was not saved need to revisist the test case", driver);
				Log.softAssertThat(!getquotepage.validateReviewRenewalFields("Automatic Renewal", "checked",extentedReport,true),"Automatic Renewal field displayed as unchecked which is expected", "Automatic Renewal field found to be checked,the unchecked flag during MTA was not saved need to revisist the test case", driver);
				Log.softAssertThat(!getquotepage.validateReviewRenewalFields("Block Renewal", "checked",extentedReport,true), "Block Renewal field is unchecked as expected", "Block Renewal field is checked, the uncheked flag during MTA was not saved need to revisist the test case", driver);
	...
	public void TC_418_419_424(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				GetQuotePage getquotepage = custdashboardpage.verifyGetQuotePage(extentedReport);
				Log.pass("Get quote page loaded successfully", driver, extentedReport, true);
			    Log.softAssertThat(getquotepage.validateReviewRenewalFields("Automatic Review", "disabled",extentedReport,true),"Automatic Review field was disabled","Automatic Review field was enabled, it should be disabled for policy entered in renewal cycle");
			    Log.softAssertThat(getquotepage.validateReviewRenewalFields("Automatic Renewal", "disabled",extentedReport,true),"Automatic Renew field was disabled","Automatic Renew field was enabled, it should be disabled for policy entered in renewal cycle");
			    Log.softAssertThat(getquotepage.validateReviewRenewalFields("Block Renewal", "disabled",extentedReport,true),"Automatic Renew field was disabled","Automatic Renew field was enabled, it should be disabled for policy entered in renewal cycle");
	...
	public void TC_422_423(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
			  ...
			  Log.softAssertThat(custdashboardpage.verify_blockedRenewalStatus(extentedReport, true), "Displays blocked renewal status in customer dashboard page", "Failed to display blocked renewal status in customer dashboard page", driver, extentedReport, true);
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				if (!getquotepage.validateReviewRenewalFields("Automatic Review", "checked", extentedReport, true)) {
					...
					if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
					  ...
					  Log.softAssertThat(custdashboardpage.verify_reviewStatus("Review Required",extentedReport, true), "Displays Review required status in customer dashboard page", "Failed to display review required status in customer dashboard page", driver, extentedReport, true);	
