...
public class UXP_EC_2247 extends BaseTest {
	...
	@Test(description = "Data Setup for 2247, Creating 2 new contacts", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 0)
	...
	public void TC_480(String browser) throws Exception {
		...
		try {
			...
			CustDashboardPage custdashboardpage = searchPage.selectContactFromSearchResult(mainCustFirstName, true,
					extentedReport);
			// Create New Quote
	...
	@Test(description = "Check that the user is able to change the payor of the policy via Billing adjustment function", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 2)
    public void TC_481(String browser) throws Exception {
        ...
        try {
            ...
            searchPage.enterFirstName(mainCustFirstName, extentedReport);
            searchPage.clickSearch(extentedReport);
            CustDashboardPage custdashboardpage = searchPage.clickSearchedContactPolicy("contact","",testData.get("Title"),true, extentedReport);
            custdashboardpage.clickNewQuote(true, extentedReport);
            custdashboardpage.enterQuoteDetails(testData, true, extentedReport);
            NewQuotePage newquotepage = custdashboardpage.clickContinueQuote(false, extentedReport);
            // Create New Quote
            ...
            billingAdjustmentPage.enterChangePayorDetails(customerDetails2.get("Last Name"), customerDetails2.get("First Name"), postcode,extentedReport,
                    true);
            String payorname = customerDetails2.get("Title") + " " + customerDetails2.get("First Name") + " " + customerDetails2.get("Last Name");   Log.softAssertThat(billingAdjustmentPage.verifyPayorName(payorname),
	...
	@Test(description = "Check that by default the policyholder is set as payor of the policy at the time of New Business", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 3)
	public void TC_482(String browser) throws Exception {
		...
		try {
			...
			searchPage.clickSearch(extentedReport);
			CustDashboardPage custdashboardpage = searchPage.selectContactFromSearchResult(firstName, true,
					extentedReport);
			custdashboardpage.clickNewQuote(true, extentedReport);
			custdashboardpage.enterQuoteDetails(testData, true, extentedReport);
			NewQuotePage newquotepage = custdashboardpage.clickContinueQuote(false, extentedReport);
	...
	@Test(description = "Check that the payor of renewal is default/set to the payor of policy before renewal", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 4)
	public void TC_484(String browser) throws Exception {
		...
		try {
			...
			String payorName = testData.get("Title") + " " + testData.get("First Name") + " "
					+ testData.get("Last Name");
			Log.softAssertThat(newquotepage.verifyPayorName(payorName),
					"The payor of renewal is default/set to the payor of policy before renewal : " + payorName,
					"The payor of renewal is not default/set to the payor of policy before renewal : " + payorName,
					driver, extentedReport, true);
			Log.testCaseResult(extentedReport);
		} // try
		catch (Exception e) {
	...
	@Test(description = "Check that the user is NOT able to select 'Payment Method' without selecting the 'Payment Plan'", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 5)
	public void TC_488(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.getPaymentMethod().equals("- Please select -"),
					...
					"The user is able to select 'Payment Method' without selecting the 'Payment Plan'", driver,
					extentedReport, true);
	...
	@Test(description = "Check that the user is navigated to 'Acceptance page' and the Card details panel contains the automatic payment reference when the payment is made successfully", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 6)
	...
	@Test(description = "Check that the stored 'Bank Details' are listed when the payment method is selected as 'Direct Debit' when the  policyholder has existing details and Check that 'Change Payor' modal gets closed on clicking the 'Cancel' & 'Close' button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 7)
	public void TC_499_504_505(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyPaymodalIsClosed(),
					...
					"'Change Payor' modal is not closed on clicking the 'Cancel' button ", driver, extentedReport);
			newquotepage.clickChangePayorButton(extentedReport, true);
			...
			Log.softAssertThat(newquotepage.verifyPaymodalIsClosed(),
					...
					"'Change Payor' modal is not closed on clicking the 'Cancel' button ", driver, extentedReport);
			Log.softAssertThat(
					newquotepage.verifyStoredBankDetailsListed("Bootle Centre, Santander, Liverpool", testData, true,
							extentedReport),
	...
	@Test(description = "Check error message for 'First Name','Last Name' , 'Date of Birth' / 'Postcode' fields are mandatory in the 'Change Payor' modal", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 8)
	public void TC_507_508_509(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					...
					driver, extentedReport, true);
			Log.softAssertThat(newquotepage.verifyPayorFieldsErrorMsg("PostCode", testData.get("Last Name"),
					testData.get("First Name"), "", newquotepage.ERROR_MSG_PAYOR_POSTCODE_OR_DOB, extentedReport),
	...
	@Test(description = "Check that the data entered in search fields are removed when 'Clear All' button is clicked before the search is performed", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_513(String browser) throws Exception {
		...
		try {
			...
			newquotepage.enterChangePayorDetail(lastName, firstName, testData.get("Post Code"), extentedReport, true);
	...
	@Test(description = "Check that the search results are removed and the modal is refreshed when 'Clear All' button is clicked after the search is performed", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 8)
	public void TC_514(String browser) throws Exception {
		...
		try {
			...
			SearchPage searchPage = new SearchPage(driver, extentedReport).get();
			searchPage.clickCreateCustomer(true, extentedReport);
			HashMap<String, String> payorDetails = searchPage.enterCustomerDetails(testData, true, extentedReport);
			...
			Log.softAssertThat(
					newquotepage.uielement.verifyPageElements(Arrays.asList("btnPayorSearchSelectRow1"), newquotepage),
					"Search result is displayed after clicking Search button",
					"Search result is not displayed after clicking Search button", driver, extentedReport, true);
	...
	@Test(description = "Check that the message 'No match found' is displayed when the search fails", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 8)
	public void TC_517(String browser) throws Exception {
		...
		String payorFirstName = GenericUtils.getRandomCharacters("alpha", 5) + testData.get("First Name") + "Payor";
		String payorLastName = GenericUtils.getRandomCharacters("alpha", 5) + testData.get("First Name") + "Payor";
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyChangePayorErrorMsg(errorMessage, extentedReport),
					...
					"The message 'No match found' is not displayed when the search fails", driver, extentedReport,
					true);
	...
	@Test(description = "Check that 'Create New Payor' button is displayed below the search results", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 8)
	public void TC_518(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					newquotepage.uielement.verifyPageElements(Arrays.asList("btnCreateNewPayor"), newquotepage),
					"'Create New Payor' button is displayed below the search results",
					"'Create New Payor' button is not displayed below the search results", driver, extentedReport,
					true);
	...
	@Test(description = "Check that the contact(s) are displayed below the search fields when search is successful", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 8)
	public void TC_515(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyChangePayorSearchResult(changePayorName, false, extentedReport),
					changePayorName + " - contact is displayed below the search fields when search is successful ",
					changePayorName + " - contact is not displayed below the search fields when search is successful ",
					driver, extentedReport, true);
	...
	@Test(description = "Check that the confirmation of the contact selection is displayed beneath the grid when 'Select' button is clicked against a particular contact", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_522(String browser) throws Exception {
		...
		try {
			...
			// Change payor
			newquotepage.clickChangePayorButton(extentedReport, false);
			newquotepage.searchAndSelectChangePayor(payorLastName, payorFirstName, testData.get("Post Code"),
					extentedReport, true);

			// Verify confirmation
			Log.softAssertThat(
					newquotepage.uielement.verifyPageElements(Arrays.asList("msgYouHaveSelect"), newquotepage),
	...
	@Test(description = "Check that the user is navigated to the Payment Panel with the original policyholder intact when 'Cancel' button is selected ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_525(String browser) throws Exception {
		...
		try {
			...
			// Verify confirmation
			Log.softAssertThat(
					newquotepage.uielement.verifyPageElements(Arrays.asList("barPaymentOption"), newquotepage),
	...
	@Test(description = "Check that the data entered into the search fields of 'Change payor' modal is auto-populated into the 'Create New Payor' modal on selecting 'Create new payor' button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_529(String browser) throws Exception {
		...
		try {
			...
			// Change payor
			newquotepage.clickChangePayorButton(extentedReport, false);
			newquotepage.enterChangePayorDetail(payorLastName, payorFirstName, postCode, extentedReport, true);
			...
			Log.softAssertThat(newquotepage.verifyLastNameTxtBoxValue(payorLastName),
					payorLastName + " - Details of Last name is auto-populated in the 'Create New Payor' modal",
					payorLastName + " - Details of Last name is not auto-populated in the 'Create New Payor' modal",
					driver, extentedReport, true);

			Log.softAssertThat(newquotepage.verifyFirstNameTxtBoxValue(payorFirstName),
					payorFirstName + " - Details of First name is auto-populated in the 'Create New Payor' modal",
					payorFirstName + " - Details of First name is not auto-populated in the 'Create New Payor' modal",
					driver, extentedReport, true);
			...
			Log.softAssertThat(newquotepage.verifyPostCodeTxtBoxValue(postCode),
					...
					postCode + " - Details of postCode is not auto-populated in the 'Create New Payor' modal", driver,
					extentedReport, true);
	...
	@Test(description = "Check that a 'New Contact' is created and payor added to the Payment Panel screen when click on 'Save' button from Create New Payor screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Check that the 'Bank Details' of the payor (if stored already) is displayed in the Payment Panel page when that contact already exists", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_536(String browser) throws Exception {
		...
		/*
		 * String branch = testData.get("Bank Branch"); String accNo =
		 * testData.get("Account Number"); String sortCode =
		 * testData.get("Sort Code");
		 */
	...
	@Test(description = "Check that the user is able to complete a New Business after changing the payor ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_540(String browser) throws Exception {
		...
		try {
			...
			// Change payor
			newquotepage.clickChangePayorButton(extentedReport, false);
			String payorname = newquotepage.selectChangePayor(payorLastName, payorFirstName, postCode, extentedReport,
					true);

			Log.softAssertThat(newquotepage.verifyPayorName(payorname),
					payorname + " - payor name is changed successfully", payorname + " - payor name is not changed",
					driver, extentedReport, true);
	...
	@Test(description = "Verify user is navigated to 'Payment hub' when the payment method is selected as 'Card (via payment hub)'", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_496(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyPaymentHub(driver), "User Navigated to Payment Hub Page : ",
					"User not Navigated to Payment Hub Page", driver, extentedReport, true);
		} // try
		catch (Exception e) {
			Log.exception(e, driver, extentedReport);
		} // catch
	...
	@Test(description = "Verify 'Enter Payment Reference' field on selecting 'confirm' button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 3)
	public void TC_495(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					...
					"User not navigated to the customer dashboard page after clicking confirm payment", driver,
					extentedReport, true);
		} // try
		catch (Exception e) {
			Log.exception(e, driver, extentedReport);
	...
	@Test(description = "Verify the 'Create New Payor' modal", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 3)
	public void TC_534(String browser) throws Exception {
		...
		try {
			...
			searchPage.clickCreateCustomer(true, extentedReport);
			HashMap<String, String> policyDetails = searchPage.enterCustomerDetails(testData, true, extentedReport);
			CustDashboardPage custdashboardpage = searchPage.confirmCreateCustomer(false, extentedReport);
			...
			Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("searchScreen"), newquotepage),
	...
	public void TC_530(String browser) throws Exception {
			...
			try {
				...
				Log.softAssertThat(searchPage1.uielement.verifyPageElements(Arrays.asList("txtPolicyNumber"), searchPage1),
						"Search Page Verified", "Search Page not Verified", driver, extentedReport, true);
				
				searchPage1.clickCreateCustomer(true, extentedReport);
				searchPage.enterCustomerDetails(testData, true, extentedReport);
				CustDashboardPage custdashboardpage1 = searchPage.confirmCreateCustomer(false, extentedReport);
				Log.softAssertThat(custdashboardpage1.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage1),
						"Custdashboardpage Verified", "Custdashboardpage not Verified", driver, extentedReport, true);
				...
				newquotepage.createNewPayorDetails(extentedReport);
				Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("titleFieldInNewPayor"), newquotepage),
						"Title Field Verified in New payor details", "Title Field not Verified in New payor details", driver, extentedReport, true);
				Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("firstNameFieldInNewPayor"), newquotepage),
						"First Name Field Verified in New payor details", "First Name Field not Verified in New payor details", driver, extentedReport, true);
				Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("lastNameFieldInNewPayor"), newquotepage),
						"Last Name Field Verified in New payor details", "Last Name Field not Verified in New payor details", driver, extentedReport, true);
				Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("addressFieldInNewPayor"), newquotepage),
						"Address Field Verified in New payor details", "Address Field not Verified in New payor details", driver, extentedReport, true);
    ...
    @Test(description = "Verify the 'Search' button on 'Change Payor' modal ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 3)
    public void TC_510(String browser) throws Exception {
			...
			try {
				...
				CustDashboardPage custdashboardpage1 = searchPage1.confirmCreateCustomer(false, extentedReport);
				custdashboardpage1.clickNewQuote(true, extentedReport);
				custdashboardpage1.enterQuoteDetails(testData, true, extentedReport);
				NewQuotePage newquotepage = custdashboardpage1.clickContinueQuote(false, extentedReport);
				// Create New Quote
				...
				newquotepage.changePayorDetails(changePayorLN,changePayorFN,changePayorPC,extentedReport);
				newquotepage.clickPayorSearchButton(extentedReport,true);
				Log.softAssertThat(newquotepage.uielement.verifyPageElements(Arrays.asList("searchResults"), newquotepage),
    ...
    @Test(description = "Verify the search results grid", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 3)
    public void TC_519(String browser) throws Exception {
			...
			try {
				...
				newquotepage.selectPayment(testData, true, extentedReport);
				newquotepage.clickChangePayorButton(extentedReport,true);
				newquotepage.changePayorDetails(changePayorLN.substring(0, 2),changePayorFN.substring(0, 2),changePayorPC,extentedReport);
				newquotepage.clickPayorSearchButton(extentedReport,true);
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is a new contact- Payor is a new contact and doesn't already exist- Payment is Annual Card- No card details therefore exist", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_001(String browser) throws Exception {
		...
		try {
			...
			// Change payor
			newquotepage.clickChangePayorButton(extentedReport, false);
			newquotepage.enterChangePayorDetail(contactLastName, contactFirstName, postCode, extentedReport, true);
			newquotepage.clickSearchBtn_ChangePayor(extentedReport);

			// Create New change payor
			newquotepage.clickCreateNewPayor(extentedReport);
			HashMap<String, String> payorDetails = newquotepage.enterCustomerDetails(testData, true, extentedReport,
					true);
			String payorFirstName = payorDetails.get("First Name");
			String payorLastName = payorDetails.get("Last Name");
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is a new contact- Payor is a new contact and doesn't already exist- Payment is Monthly Direct Debit- No Bank Details therefore exist", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_002(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyNoAccountDetailMsg(message), "Account details does not exists",
					"Account details does exists", driver, extentedReport, true);
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is a new contact- Payor is an existing contact and already exists- Payment is Annual Card- Card details are not stored", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is a new contact- Payor is an existing contact and already exists- Payment is Monthly Direct Debit- Use existing Bank Account", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_004(String browser) throws Exception {
		...
		try {
			...
			newquotepage.selectAccount(sortCode, branch, accName, accNo, extentedReport, true);
			Log.softAssertThat(newquotepage.verifyAccountSelection(sortCode, branch, accName, accNo, extentedReport),
					"Existing Bank account is selected", "Existing Bank account is not selected",
					driver, extentedReport, true);
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is a new contact- Payor is an existing contact and already exists- Payment is Monthly Direct Debit- Add new Bank account and select", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_005(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyAccountSelection(sortCode, branch, newAccName, accNo, extentedReport),
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is an existing contact- Payor is a new contact and doesn't already exist- Payment is Annual Card- No card details are stored", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_006(String browser) throws Exception {
		...
		try {
			...
			// Change payor
			newquotepage.clickChangePayorButton(extentedReport, false);
			newquotepage.enterChangePayorDetail(custLastName, custFirstName, postCode, extentedReport, true);
			newquotepage.clickSearchBtn_ChangePayor(extentedReport);
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is an existing contact- Payor is a new contact and doesn't already exist- Payment is Monthly Direct Debit- Add new Bank account and select", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is an existing contact- Payor is an existing contact and already exists- Payment is Annual Card- No card details are stored", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is an existing contact- Payor is an existing contact and already exists- Payment is Monthly Direct Debit- Add new Bank account and select", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Change the payor in respect of a New Business Quote- Contact (Policyholder) is an existing contact- Payor is an existing contact and already exists- Use existing Bank Account", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	public void BS_013(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat((policyDetail.get("Status").toString().equalsIgnoreCase(expectedPolicyStatus)),
	...
	public void BS_014(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(newquotepage.verifyAccountSelection(sortCode, branch, newAccName, accNo, extentedReport),
					"New Bank Account detail is added and selected", "New Bank Account detail is not added and not selected",
					driver, extentedReport, true);
