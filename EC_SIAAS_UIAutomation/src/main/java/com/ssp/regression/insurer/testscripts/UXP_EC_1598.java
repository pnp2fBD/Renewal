...
public class UXP_EC_1598 extends BaseTest {
	...
	@Test(description = "To check Mailing Address checkbox is checked for the address which has marked Yes for mailing address", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Check that the Address Detail section is displayed In the Manage Contact Details modal, select edit against a MANUAL address to reveal the address details", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_034(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					...
					"System did not displays Replace Address Section & Address Details Section", driver, extentedReport,
					true);
	...
	@Test(description = "To check fields are getting disable after click in the  Mailing address Edit button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check user will be prompted to search for a new address after click in the Edit button", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_038(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					...
					"System prompted to search for a new address", "System not prompted to search for a new address",
					driver, extentedReport);
	...
	@Test(description = "To check user can not search address only by entering Housename or number", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_039(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(manageContactDetailsPg.verifyPostCodeErrorMsg(manageContactDetailsPg.POSTCODE_ERROR_MSG),
					"System throw error message : " + manageContactDetailsPg.POSTCODE_ERROR_MSG,
					"System did not throw error message : " + manageContactDetailsPg.POSTCODE_ERROR_MSG, driver,
					extentedReport, true);
	...
	@Test(description = "To check user can enter search criteria into the Postcode for triggering  quick address search", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_040(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(manageContactDetailsPg.verifyManageContactDetailsFields(),
					...
					driver, extentedReport, true);
			manageContactDetailsPg.clickEditButton(extentedReport, true);
			manageContactDetailsPg.enterReplaceAddressDetails("PostCode", "AB101AH", extentedReport, true);
			manageContactDetailsPg.clickFindAddressButton(extentedReport, false);
			Log.softAssertThat(
...
//							+ manageContactDetailsPg.getPostCodeAddressFromList(),
	...
	@Test(description = "To check user enter housename/number & Postcode to find exact address", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_041(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(manageContactDetailsPg.verifyManageContactDetailsFields(),
					...
					driver, extentedReport, true);
			manageContactDetailsPg.clickEditButton(extentedReport, true);
			manageContactDetailsPg.enterReplaceAddressDetails("HouseName", "Aberdeen City Council", extentedReport,
					true);
	...
	@Test(description = "To Check whether the Address details pane is closed when clicking Cancel button while editing address", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check user can able to enter address manually by selecting or Enter Manually link to change the address", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check  User able to replace address in the Manage Contact Detail screen by using Quick Search  and 'or Enter Manually' link", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_045(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(manageContactDetailsPg.verifyReplaceAddressTypeAndHouseNameDisabled(),
					"System not displayed Housename or number field", "System displayed Housename or number field",
					driver, extentedReport, true);
	...
	@Test(description = "To check all fields are getting display after selecting 'or Enter Manually' link in Replace Address Section", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_046(String browser) throws Exception {
		...
		try {
			...
			manageContactDetailsPg.clickEditButton(extentedReport, true);
			manageContactDetailsPg.clickEnterManuallyLink(extentedReport, false);
			Log.softAssertThat(manageContactDetailsPg.uielement.verifyPageElements(Arrays.asList("fldReplaceAddressLine1", "fldReplaceAddressLine2",
											"fldReplaceAddressLine3", "fldReplaceCountry","fldReplaceAddressPostCode", "btnCancel", "btnSave"),
									manageContactDetailsPg),
	...
	@Test(description = "To check that if the address you changed is the mailing address, that when you return to the customer dashboard the new address is displayed in the Contact Details section", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Verify that corprate contact is able to replace", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_002(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					...
					"System did not displays Replace Address Section", driver, extentedReport,
					true);
			Log.testCaseResult(extentedReport);
		} 
		catch (Exception e) {
	...
	@Test(groups = "Business_Scenario", description = "Check that able to add multiple mailing address", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_004(String browser) throws Exception {
		...
		try {
			...
			manageContactDetailsPg = custdashboardpage.verifyndClickManageCntDetails(extentedReport, false);
			for (String postCode : address) {
				Log.softAssertThat(manageContactDetailsPg.verifyFullAddressPostCode(postCode),
						"User is able to add multiple address",
						"User is not able to add multiple address",
						driver, extentedReport, true);
			}
	...
	@Test(groups = "Business_Scenario", description = "Change the Mailing Adrress and Start MTA process and check whether correct address is being reflected", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Verify that address lookup option should be available after user has selected address but not yet saved and also User should have option to delete the address for starting fresh search", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_008(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					manageContactDetailsPg.uielement.verifyPageElements(Arrays.asList("lstAddAddressPostCodeDetail"), manageContactDetailsPg),
					"Address Look Up option is available after find the address by postcode", "Address Look Up option is not available in manage contact details page", driver,
					extentedReport, true);
			Log.testCaseResult(extentedReport);
