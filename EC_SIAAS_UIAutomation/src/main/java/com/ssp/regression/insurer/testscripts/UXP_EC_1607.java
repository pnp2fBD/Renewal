...
public class UXP_EC_1607 extends BaseTest {
	...
	@Test(description = "Check that 'Reverse Transaction' modal is displayed on clicking 'Reverse Transaction' option from the Policy Details section", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 0)
	...
	@Test(description = "Check that 'Reverse Transaction' option is available under the 'Manage Policy' sub-section after performing MTA in EC application ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 1)
	...
	@Test(description = "Check that 'Reverse Transaction' is done in chronological order with most recent transaction first", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 2)
	public void TC_220(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(custdashboardpage.verifyMTATransactionStatus(),
					...
					"'Reverse Transaction' are not in chronological order with most recent transaction first", driver,
					extentedReport, true);
			Log.testCaseResult(extentedReport);
		} // try
		catch (Exception e) {
	...
	@Test(description = "Check that 'Reverse Transaction' is done for the latest date when multiple MTAs are performed in EC application", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 3)
	...
	@Test(description = "Check that 'Reverse Transaction' option is available under the 'Manage Policy' sub-section after performing Renewal in EC application", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 4)
	...
	@Test(description = "Check that 'Reverse Transaction' option is greyed out and NOT selectable under the 'Manage Policy' sub-section after performing New Business in EC application", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 4)
	...
	@Test(description = "Check that 'Reverse Transaction' option is greyed out and NOT selectable under the 'Manage Policy' sub-section after creating a New Quote in EC application(Manage Quote tab should NOT display Reverse Transaction tab", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 4)
	...
	@Test(description = "Check that 'Reverse Transaction' option is greyed out and NOT selectable under the 'Manage Policy' sub-section after Cancellation in EC application", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 4)
	...
	@Test(description = "Check that 'Reverse Transaction' option is greyed out and NOT selectable under the 'Manage Policy' sub-section after Reinstatement in EC application ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 4)
	...
	@Test(description = "Check that the status of a policy is displayed as 'Inactive and Reversed' when a Reverse Transaction is performed in EC application", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 5)
	...
	@Test(description = "Check that the 'Balance' of policy is also reversed upon successful Reverse Transaction in the EC application", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 6)
	...
	@Test(groups="Business_Scenario",description = "To perform New business, MTA, Reverse transaction, cancelling policy, Reinstate, MTA and Reverse Transaction", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
		...
		try {
			...
			Log.softAssertThat(
				...
				if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
					...
					Log.fail("Failed - MTA Policy Created in " + policyDetails.get("Status").toString() + " status", driver,
							extentedReport, true);
				}	
				custdashboardpage.selectTabDropdown("Manage Policy", extentedReport, false);
				custdashboardpage.clickReverseTransaction(extentedReport);			custdashboardpage.selectReverseTransType("Client Request", extentedReport, true);
				custdashboardpage.clickConfirmReversalButton(extentedReport);
				...
				Log.softAssertThat(policyDetailcnl.get("Position").toString().equalsIgnoreCase("cancellation"),
						"Policy position displaying as cancellation", "Latest position is not displaying as cancellation");
				custdashboardpage.clickReinstatePolicy(true, extentedReport);
				custdashboardpage.selectReinstateReason(testData, true, extentedReport);
				custdashboardpage.clickCalculateForReinstate(false, extentedReport);
				...
				Log.softAssertThat(policyDetailRIN.get("Position").toString().equalsIgnoreCase("NewBusiness"),
						"Policy position displaying as Reinstatement", "Latest position is not displaying as Reinstatement");
				...
				for (int i = 0; i < coversToAdd.length; i++) {
					boolean BoolVal =false;
					String ins_RowtoInteract = getquotepage1.SelectInsuranceItem(coversToAdd[i], true, extentedReport);
					BoolVal = getquotepage1.enterInsCoverDetails(testData, coversToAdd[i], ins_RowtoInteract, true,
							extentedReport);
					String[] coverType = coversToAdd[i].split("_");
				if (BoolVal != false) 
				{
				...
				Log.softAssertThat(getquotepage11.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
	...
	@Test(groups="Business_Scenario",description = "To perform New business, Cancelling Policy and Reinstate the policy", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_007(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
				...
				custdashboardpage.clickConfirmForReinstate(true, extentedReport);
				HashMap<String, String> policyDetailRIN=custdashboardpage.getPolicyURN(extentedReport);
				Log.softAssertThat(policyDetailRIN.get("Position").toString().equalsIgnoreCase("Reinstatement"),
						"Policy position displaying as Reinstatement", "Latest position is not displaying as Reinstatement");
		}
		catch (Exception e) {
			Log.exception(e, driver, extentedReport);
	...
	@Test(groups="Business_Scenario",description = "Perform New business, Renewal and MTA", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 4)
	...
	@Test(groups="Business_Scenario",description = "To perform New business, MTA, STA, Reverse Transaction", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_004(String browser) throws Exception {
		...
		newquotepage = getquotepage11.confirmPaymentOnMTA("MTA", testData, extentedReport);
		Log.softAssertThat(
				custdashboardpage1.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage1),
				"Navigated to Customer dashboard page", "Not navigated to Customer dashboard page", driver,
				extentedReport, true);
	   ...
	   // Recalculate and buy
		...
		if (policyDetails.get("Status").toString().equalsIgnoreCase("NewBusiness")) {
			...
			Log.fail("Failed - STA Policy Created in " + policyDetails.get("Status").toString() + " status", driver,
					extentedReport, true);
		}	
		//Reverse Transaction
		custdashboardpage.selectTabDropdown("Manage Policy", extentedReport, false);
	...
	@Test(groups="Business_Scenario",description = "To perform New business, MTA, MTA1 with Quoted State, MTA! with Completed state", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_005(String browser) throws Exception {
		...
		for (int i = 0; i < coversToAdd1.length; i++) {
			boolean BoolVal =false;
			String ins_RowtoInteract = getquotepage2.SelectInsuranceItem(coversToAdd1[i], true, extentedReport);
			BoolVal = getquotepage2.enterInsCoverDetails(testData, coversToAdd1[i], ins_RowtoInteract, true,
					extentedReport);
	...
	@Test(groups="Business_Scenario",description = "To perform New business, MTA1 with Add Premium, MTA2 with Remove premium, MTA3 with Zero Premium,Reversed all transactions and MTA with Add Premium", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_001(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
				...
				Log.softAssertThat(getquotepage2.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
				...
				Log.softAssertThat(getquotepage3.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
				...
				for (int i = 0; i < coversToAdd1.length; i++) {
					boolean BoolVal =false;
					String ins_RowtoInteract = getquotePage.SelectInsuranceItem(coversToAdd1[i], true, extentedReport);
					BoolVal = getquotePage.enterInsCoverDetails(testData, coversToAdd1[i], ins_RowtoInteract, true,
							extentedReport);
					String[] coverType = coversToAdd1[i].split("_");
				if (BoolVal != false) 
				{
				...
				Log.softAssertThat(getquotepage5.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
