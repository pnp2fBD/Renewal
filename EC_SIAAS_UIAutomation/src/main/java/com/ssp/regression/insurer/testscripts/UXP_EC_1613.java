...
public class UXP_EC_1613 extends BaseTest {
	...
	@Test(description = "To check that the latest renewal position of the policy is only displayed, if renewal is not blocked for that policy. To check that the 'Manage Renewals' tab is displayed, if the User has the permission to perform 'invite renewal'. To check that the 'Manage Renewals' tab is displayed, if the policy is within the date tolerances for renewal as defined on the product / scheme", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the Manage Renewals tab is NOT displayed, if the User does NOT have the permission to perform invite renewal, To check that the 'Manage Renewals' tab is NOT displayed, if the policy is NOT within the date tolerances for renewal as defined on the product / scheme ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_341_343(String browser) throws Exception {
		...
		try {
			 ...
			 * custdashboardpage.selectNewQuoteDetails(testData, extentedReport,
			 * true);
			 */
			NewQuotePage newquotepage = custdashboardpage.clickContinueQuote(true, extentedReport);
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElementsDoNotExist(Arrays.asList("drpManageRenewals"),
								custdashboardpage),
	...
	@Test(description = "To check that the 'Manage Renewals' tab is NOT displayed, if the policy is in a 'Cancelled' status,  To check that the 'Manage Renewals' tab is displayed, if the cancelled policy is re-instatement ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 4)
	public void TC_344_346(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				custdashboardpage.enterRequestCancellationDetails("No Refund", "Better Quote", extentedReport);
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElementsDoNotExist(Arrays.asList("drpManageRenewals"),
								custdashboardpage),
						"Manage renewal tab is not dispalyed on customer dashaboard page",
	...
	@Test(description = "To check that the user landed on the 'data capture' screens,if the user click on 'Continue'option, To check that the existing policy details is displayed by default in the 'Data capture' screen, To check that the new cover start date is displayed by default and it is protected , To check that the 'Invite Renewal' option is available for selection, if the policy is eligible for renewal ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_354_355_357_349_358(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(newquotepage.rnlIncpt(policyDetails.get("InceptionDate"), true, extentedReport),
	...
	@Test(description = "To check that the 'Save' and 'Get Quote' options are available, if the declaration has been confirmed ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	public void TC_359_361(String browser) throws Exception {
		...
		try {
			...
			newquotepage.clickAgree(extentedReport);
			Log.softAssertThat(
					newquotepage.uielement.verifyPageElements(Arrays.asList("btn_SaveQuoteAfterTerms", "btnGetQuote"),
							newquotepage),
					"Save and getquote buttons are displayed on customer dashboard page",
					"Save and Getquote buttons are not dispalying on customer dashboard page", driver, extentedReport,
					true);
			// Get and Buy Quote
			newquotepage.clickGetQuote(extentedReport);
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(newquotepage.verifyTabTitles("pricepresentation", true, extentedReport),
						"Navigated to Price presentation page", "Not navigated to price prsentation page", driver,
						extentedReport, true);
				newquotepage.clickQuoteSave("Renew", "Renewal Quote", extentedReport);
	...
	@Test(description = "To check that the following buttons are available in the 'Price presentation' screen Back to 'Data Capture' 'Save' 'Buy' and To check that the renewal of selected policy is saved as ‘Review Required’ and the User returned to the Customer Dashboard, if the User selects 'Save' option in the 'Price presentation' page", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	public void TC_362_364(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				// TC_362
				Log.softAssertThat(policyDetailsrnl.get("notification_plcy").toString().equalsIgnoreCase("R"),
						"Policy position displaying as Renewal", "Latest position is not displaying");
			} else {
				Log.fail("Failed - NB Policy Created in " + policyDetails.get("Status").toString()
						+ " status, unable to proceed with renewal transaction", driver, extentedReport, true);
	...
	@Test(description = "To check that the user is return back to 'Data capture' screen, if the User selects 'Back to Data Capture' option", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the user is allowed to modify the 'Change Payment Plan / Method' details in the 'Acceptance' screen. To check that the user is allowed to make payment in accordance with payment method chosen in the 'Acceptance' screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "To check that the user is allowed to modify the 'Change Payor' details in the Acceptance screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", priority = 1)
	public void TC_370(String browser) throws Exception {
		...
		try {
			...
			// extentedReport);
			List<String> jointPolicyholderdetails = searchPage.enterJointCustomerDetails(testData, true,
					extentedReport);
			CustDashboardPage custdashboardpage1 = searchPage.confirmCreateCustomer(true, extentedReport);
			System.out.println("customer first name" + jointPolicyholderdetails.get(0) + "Customer last name"
					+ jointPolicyholderdetails.get(1));

			custdashboardpage1.clickComplete(extentedReport);
			homePage.clickTakeCall(extentedReport);
			homePage.clickMyBrands(brandname, extentedReport);
			searchPage.clickCreateCustomer(true, extentedReport);
			HashMap<String, String> custDetails = searchPage.enterCustomerDetails(testData, true, extentedReport, true);
			CustDashboardPage custdashboardpage = searchPage.confirmCreateCustomer(true, extentedReport);
	...
	@Test(description = "To check that the user is allowed to modify the 'User Preferences' details in the 'Acceptance' screen", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(description = "Check that the user is allowed to Review/Amend T’s and C’s details", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_368(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				// Verify T&C is added
				Log.softAssertThat(buyQuotePage.verifyTandCPolicyadded(policyToSelect, extentedReport, false),
						policyToSelect + " - T&C is added under terms & condition section",
						policyToSelect + " - T&C is not added under terms & condition section", driver, extentedReport,
						true);
	...
	@Test(description = "To check that the Notification column is displayed with 'L' flag for lapsed renewal", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_376_378(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				HashMap<String, String> policyDetailsrnl = custdashboardpage.getPolicyURN(extentedReport);
				Log.softAssertThat(policyDetailsrnl.get("notification_plcy").toString().equalsIgnoreCase("L"),
	...
	@Test(description = "The Notification column should be displayed with 'R' flag (red olior) for review required selected policy. The position and Status of the policy which reqiure review for renewal the policy, should be displayed as 'Renewal' and status as 'Review Required'", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void TC_379_380_381(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				newquotepage.clickRenewalQuoteBuy(extentedReport);
				BuyQuotePage buyQuotePage = new BuyQuotePage(driver, extentedReport);
				buyQuotePage.clicksave_LapsebuttoninAcceptancepage("Review Required", "QuoteDescription", "Save",
						extentedReport);
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"),
								custdashboardpage),
	...
	@Test(description = "The Notification column should be displayed with 'R' flag (Green Color) for required selected policy. The position and Status of the policy which is reviewed for renewal the policy, should be displayed as 'Renewal' and status as 'Reviewed'", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Invite a policy, save as renewal reviewed, green R, then do an MTA, complete the MTA and check that the renewal has gone back to a red R", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(
						...
						"Failed to Navigate to custdashboardpage after quote Reviewed", driver, extentedReport, true);
				...
				for (int i = 0; i < coversToAdd.length; i++) {
					...
					String ins_RowtoInteract = getquotepage.SelectInsuranceItem(coversToAdd[i], true, extentedReport);
					...
					if (BoolVal != false) {
						...
						Log.fail("Failed to " + coverType[2] + " " + coverType[0] + " cover", driver, extentedReport,
								true);
					}
				...
				Log.softAssertThat(getquotepage.verifyPaymentTrasaction(extentedReport), "Payment is successful",
				...
				if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
					...
					Log.fail("Failed - MTA Policy Created in " + policyDetails.get("Status").toString() + " status",
							driver, extentedReport, true);
				}
	...
	@Test(groups = "Business_Scenario", description = "To check that the user is able to reverse the completed renewal policy", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_652_683(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(policyDetailsrnl.get("Position").toString().equalsIgnoreCase("NewBusiness"),
	...
	@Test(groups = "Business_Scenario", description = " Reinstate a cancelled direct debit renewal policy, then attempt an MTA", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "On a lapsed quote, can I get it back to reinvite", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "To check that the latest renewal position of the policy is only displayed, if renewal is not blocked for that policy. To check that the 'Manage Renewals' tab is displayed, if the User has the permission to perform 'invite renewal'. To check that the 'Manage Renewals' tab is displayed, if the policy is within the date tolerances for renewal as defined on the product / scheme, Check that it is clear during renewal cycle that a policy is in the renewal cycle", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "To Check that a reinstated policy is accessible if dates are relevant", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_716(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(custdashboardpage.verifyTabUnderPolicyHolder("Reinstate Policy", extentedReport, true),
	...
	@Test(groups = "Business_Scenario", description = "In Renewals variations, check that you can do multiple variations and that each previous one is set to lapsed", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_714_715_719_718(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				custdashboardpage.ClickOptionInRenewalQuoteVariations(quoteDescription1, extentedReport, true);
				...
				Log.softAssertThat(
						custdashboardpage.verifyOptionInRenewalQuoteVariations(quoteDescription2, extentedReport, true),
				...
				custdashboardpage.clickRenewalQuoteVariations(extentedReport, true);
				custdashboardpage.ClickOptionInRenewalQuoteVariations(quoteDescription2, extentedReport, true);
				buyQuotePage.clicksavebuttoninAcceptancepage(quoteDescription3, extentedReport);
				custdashboardpage.clickRenewalQuoteVariations(extentedReport, true);
				Log.softAssertThat(
						custdashboardpage.verifyOptionInRenewalQuoteVariations(quoteDescription3, extentedReport, true),
				...
				Log.softAssertThat(
						(custdashboardpage.verifyStatusForQuoteVariations(quoteDescription3, "R", extentedReport, true)
								...
								&& custdashboardpage.verifyStatusForQuoteVariations(quoteDescription1, "L",
										extentedReport, true)),
						"Recent quote " + quoteDescription3 + " is active and remaining Quotes " + quoteDescription1
								+ ", " + quoteDescription2 + " are lapsed",
						"Recent quote " + quoteDescription3 + " is not active and remaining Quotes " + quoteDescription1
								+ ", " + quoteDescription2 + " are not lapsed",
			...
			// Click continue button
			getquotepage = carddetailspage.clickContinueButton_getQuote(extentedReport);
			Log.softAssertThat(getquotepage.verifyPaymentTrasaction(extentedReport), "Payment was successful",
					"Payment was not successful", driver, extentedReport, true);
	...
	@Test(groups = "Business_Scenario", description = "To Check that you cannot change inception dates on renewal invitation and Check that on renewal invite in EC I am forced to view the terms and conditions", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(
						...
						"Popup and inception date are not displayed to change the date.", driver, extentedReport, true);
				...
				Log.softAssertThat(custdashboardpage.verifyContactAddressDetails(address),
						...
						"System not displayed newly mailing address under Contact Detail section : " + address, driver,
						extentedReport, true);
			}
			Log.testCaseResult(extentedReport);
	...
	@Test(groups = "Business_Scenario", description = "Check that during manual invite on EC, it is possible to change payor to search for an existing payor and select", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_704(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				String payorname = newquotepage.enterChangePayorDetails(ChangePayorlastName, ChangePayorfirstName,
				...
				Log.softAssertThat(newquotepage.verifyPayorName(payorname),
						...
						driver, extentedReport, true);
				Log.softAssertThat(
						buyQuotePage.uielement.verifyPageElements(Arrays.asList("chkBx_toMakePayment"), buyQuotePage),
						"Confirm checkbox to take payment Button is present before change new payer ",
						"Confirm checkbox to take payment Button is not present before change new payer ", driver,
						extentedReport, true);
	...
	@Test(groups = "Business_Scenario", description = "Check that able Renew the policy and able to pay in the original payment method", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_690(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				// Click continue button
				buyQuotePage = carddetailspage.clickContinueButton_buyQuote(extentedReport);
				Log.softAssertThat(buyQuotePage.verifyPaymentTrasaction(extentedReport), "Payment was successful",
						"Payment was not successful", driver, extentedReport, true);
				...
				Log.softAssertThat(
						!(custdashboardpage.uielement.verifyPageElements(Arrays.asList("drpManageRenewals"),
								custdashboardpage)),
						"Manage renewal tab is not present so cannot be invited again", "Manage renewal tab is present",
						driver, extentedReport, true);
	...
	@Test(groups = "Business_Scenario", description = "Verify that after renewal do MTA and pay in alternative payment method", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Check that it is possible during renewal to create a brand new payor, check that button indicating they were spoken to is enabled, Check that where payor is not changed on a renewal the button indicating they are spoken to is not there", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "On renewal invite check that direct debit agreement is enabled and can be ticked ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_707(String browser) throws Exception {
		...
		try {
			...
			HomePage homePage = loginPage.loginToSSP(userName, password, false, extentedReport);
			Log.softAssertThat(homePage.verifyHomePage(),
					"Successfully logged into UXP Home Page with User id:" + userName + "& Password:" + password + "",
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(
						!(buyQuotePage.uielement.verifyPageElementsDisabled(Arrays.asList("checkbox_CustAgree"),
								buyQuotePage)),
						"Customer agreement is enabled", "Customer agreement is not enabled", driver, extentedReport,
						true);
				buyQuotePage.clickCutomerAgreeButton(extentedReport);
	...
	@Test(groups = "Business_Scenario", description = " Verify that able carry out an MTA, accept and pay for it whilst the policy is in the renewal cycle and automatically have the renewal re-invited based on the amended policy details", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	@Test(groups = "Business_Scenario", description = "Check that we can add or remove cover during renewal invite, including add-ons", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_713(String browser) throws Exception {
		...
		try {
			...
			if (BoolVal != false) {
				Log.pass(coverType[2] + " " + coverType[0] + " cover done successfully", driver, extentedReport, true);
			} else {
	...
	@Test(groups = "Business_Scenario", description = "Check that a policy which is previously flagged with suspend billing during billing adjustment is forced out of renewal cycle (need to check that the product is set up with the referral rules that say this is a referral reason", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElements(Arrays.asList("drpManageRenewals"),
								custdashboardpage),
						"Manage renwal tab is present before suspend billing", "Manage renwal tab is not present before suspend billing", driver, extentedReport, true);
				...
				Log.softAssertThat(
						!(custdashboardpage.uielement.verifyPageElements(Arrays.asList("drpManageRenewals"),
								custdashboardpage)),
						"Manage renwal tab is not present after suspend billing", "Manage renwal tab is present after suspend billing", driver, extentedReport, true);
			} else {
				Log.fail("Failed - NB Policy Created in " + policyDetails.get("Status").toString()
						+ " status, unable to proceed with renewal transaction", driver, extentedReport, true);
			}
	...
	@Test(groups = "Business_Scenario", description = "Invite Renewal for a policy with outstanding debt", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_720(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(
						custdashboardpage.verifyOutstandingWarningPopup(extentedReport),
							
						"Outstanding dept warning message is present", "Outstanding dept warning message is not present", driver, extentedReport, true);
	...
	@Test(groups = "Business_Scenario", description = "Check preferred payment date is still in place on renewal ", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_709(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				Log.softAssertThat(buyQuotePage.verifyPreferredPaymentDay(preferredDay), "Preferred payment day is not changed during renewal",
	...
	@Test(groups = "Business_Scenario", description = "Payment details should be defaulted to what is displayed on policy,Check that during invite from within EC, the original payment methods are not overwritten and that they default in, i.e if direct debit then it still shows as direct debit", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_721_663(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				BuyQuotePage buyQuotePage = custdashboardpage.performRenewals_QuoteVariation(extentedReport, true);
				Log.softAssertThat(buyQuotePage.verifyPaymentPlan(paymentPlan), "Payment plan is not changed during renewal",
						"Payment plan is changed during renewal", driver, extentedReport, true);
	...
	@Test(groups = "Business_Scenario", description = "Check a policy that has had do not invite flag unticked during MTA goes to red ‘R’", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	public void BS_662(String browser) throws Exception {
		...
		try {
			...
			if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
				...
				if (!getquotepage.validateReviewRenewalFields("Automatic Review", "checked", extentedReport, true)) {
