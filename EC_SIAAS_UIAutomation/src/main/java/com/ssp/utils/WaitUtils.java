...
public class WaitUtils {
    ...
    public static void waitForSpinner(final WebDriver driver) {
        ...
        try {
            Thread.sleep(2000);
            (new WebDriverWait(driver, 60).pollingEvery(500, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class, StaleElementReferenceException.class).withMessage("Page document is not loading")).until(documentLoad);
            (new WebDriverWait(driver, 60).pollingEvery(500, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class, StaleElementReferenceException.class).withMessage("Page document is not loading")).until(imagesLoad);
            (new WebDriverWait(driver, 60).pollingEvery(500, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class, StaleElementReferenceException.class).withMessage("Realize spinners/page not loading")).until(spinnerLoad);
        } catch (Exception ex) {
    ...
    public static void waitForElementPresent(WebDriver driver, WebElement elementTocheck, String msg) {
        (new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class, StaleElementReferenceException.class).withMessage(msg)).until(ExpectedConditions.visibilityOf(elementTocheck));
    ...
    public static void waitForinvisiblityofListElement(WebDriver driver, int seconds, String locator, String msg) {
        ...
        (new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class, StaleElementReferenceException.class).withMessage(msg)).until((ExpectedConditions.invisibilityOfAllElements(Elements_toFind)));
    ...
    public static void waitForelementToBeClickable(WebDriver driver, WebElement elementTocheck, String msg) {
        (new WebDriverWait(driver, 180).pollingEvery(200, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class, StaleElementReferenceException.class).withMessage(msg)).until(ExpectedConditions.elementToBeClickable(elementTocheck));
    }
