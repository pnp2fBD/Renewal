...
public class ElementLayer {
    ...
    public boolean verifyPageElementsChecked(List<String> expectedElements, Object obj) throws Exception {
        ...
        for (String expEle : expectedElements) {
           ...
           (new WebDriverWait(driver, 5).pollingEvery(250, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class).withMessage("Element is not checked")).until(ExpectedConditions.visibilityOf(element));
